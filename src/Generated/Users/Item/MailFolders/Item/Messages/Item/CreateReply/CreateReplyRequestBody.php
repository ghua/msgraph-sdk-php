...
class CreateReplyRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return CreateReplyRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): CreateReplyRequestBody {
