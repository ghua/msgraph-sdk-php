...
use Microsoft\Graph\Generated\Users\Item\Planner\Plans\Item\Tasks\Item\PlannerTaskItemRequestBuilder;
...
class PlannerPlanItemRequestBuilder 
{
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Generated.users.item.planner.plans.item.buckets.item collection
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/users/{user%2Did}/planner/plans/{plannerPlan%2Did}{?%24select,%24expand}';
    ...
    */
     ...
     * @return RequestInformation
    */
    public function createPatchRequestInformation(PlannerPlan $body, ?array $headers = null, ?array $options = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = $this->urlTemplate;
        $requestInfo->pathParameters = $this->pathParameters;
    ...
    */
    public function get(?array $queryParameters = null, ?array $headers = null, ?array $options = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            return $this->requestAdapter->sendAsync($requestInfo, PlannerPlan::class, $responseHandler);
        } catch(Exception $ex) {
            return new RejectedPromise($ex);
        }
    }
     ...
     * @return Promise
    */
    public function patch(PlannerPlan $body, ?array $headers = null, ?array $options = null, ?ResponseHandler $responseHandler = null): Promise {
    ...
    /**
     * Gets an item from the Microsoft\Graph\Generated.users.item.planner.plans.item.tasks.item collection
     * @param string $id Unique identifier of the item
