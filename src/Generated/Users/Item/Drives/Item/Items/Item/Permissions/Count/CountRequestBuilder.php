...
namespace Microsoft\Graph\Generated\Users\Item\Drives\Item\Items\Item\Permissions\Count;
...
class CountRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/permissions/$count';
