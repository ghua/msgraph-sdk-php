...
class NotebookItemRequestBuilder 
{
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Generated.users.item.onenote.notebooks.item.sectionGroups.item collection
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Generated.users.item.onenote.notebooks.item.sections.item collection
     * @param string $id Unique identifier of the item
