...
class SectionGroupItemRequestBuilder 
{
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Generated.users.item.onenote.sectionGroups.item.sectionGroups.item collection
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Generated.users.item.onenote.sectionGroups.item.sections.item collection
     * @param string $id Unique identifier of the item
