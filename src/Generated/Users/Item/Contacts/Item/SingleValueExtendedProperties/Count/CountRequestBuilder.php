...
namespace Microsoft\Graph\Generated\Users\Item\Contacts\Item\SingleValueExtendedProperties\Count;
...
class CountRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/users/{user%2Did}/contacts/{contact%2Did}/singleValueExtendedProperties/$count';
