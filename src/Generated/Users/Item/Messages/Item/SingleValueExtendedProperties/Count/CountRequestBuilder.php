...
namespace Microsoft\Graph\Generated\Users\Item\Messages\Item\SingleValueExtendedProperties\Count;
...
class CountRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/users/{user%2Did}/messages/{message%2Did}/singleValueExtendedProperties/$count';
