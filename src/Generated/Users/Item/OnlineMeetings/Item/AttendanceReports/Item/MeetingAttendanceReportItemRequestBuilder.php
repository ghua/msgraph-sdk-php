...
class MeetingAttendanceReportItemRequestBuilder 
{
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Generated.users.item.onlineMeetings.item.attendanceReports.item.attendanceRecords.item collection
    ...
    */
     ...
     * @return RequestInformation
    */
    public function createPatchRequestInformation(MeetingAttendanceReport $body, ?array $headers = null, ?array $options = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = $this->urlTemplate;
        $requestInfo->pathParameters = $this->pathParameters;
    ...
    */
    public function get(?array $queryParameters = null, ?array $headers = null, ?array $options = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            return $this->requestAdapter->sendAsync($requestInfo, MeetingAttendanceReport::class, $responseHandler);
        } catch(Exception $ex) {
            return new RejectedPromise($ex);
        }
    }
     ...
     * @return Promise
    */
    public function patch(MeetingAttendanceReport $body, ?array $headers = null, ?array $options = null, ?ResponseHandler $responseHandler = null): Promise {
