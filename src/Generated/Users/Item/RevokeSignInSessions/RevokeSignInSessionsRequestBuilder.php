...
class RevokeSignInSessionsRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/users/{user%2Did}/microsoft.graph.revokeSignInSessions';
    ...
    */
    public function post(?array $headers = null, ?array $options = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            return $this->requestAdapter->sendAsync($requestInfo, RevokeSignInSessionsResponse::class, $responseHandler);
        } catch(Exception $ex) {
