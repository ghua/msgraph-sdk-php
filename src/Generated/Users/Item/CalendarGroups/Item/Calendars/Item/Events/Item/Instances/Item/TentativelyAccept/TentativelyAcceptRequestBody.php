...
class TentativelyAcceptRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): TentativelyAcceptRequestBody {
