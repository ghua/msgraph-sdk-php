...
class WipeManagedAppRegistrationsByDeviceTagRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return WipeManagedAppRegistrationsByDeviceTagRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): WipeManagedAppRegistrationsByDeviceTagRequestBody {
