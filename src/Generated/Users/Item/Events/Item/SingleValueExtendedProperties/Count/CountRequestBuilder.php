...
namespace Microsoft\Graph\Generated\Users\Item\Events\Item\SingleValueExtendedProperties\Count;
...
class CountRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/users/{user%2Did}/events/{event%2Did}/singleValueExtendedProperties/$count';
