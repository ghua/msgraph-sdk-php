...
class GetManagedAppDiagnosticStatusesResponse implements AdditionalDataHolder, Parsable 
{
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): GetManagedAppDiagnosticStatusesResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        $currentObject = $this;
        return  [
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(ManagedAppDiagnosticStatus::class)); },
        ];
    }
