...
class SendActivityNotificationRequestBuilder 
{
    ...
    */
     ...
     * @param SendActivityNotificationRequestBody $body 
     * @param array<string, mixed>|null $headers Request headers
     * @param array<string, RequestOption>|null $options Request options
     * @return RequestInformation
    */
    public function createPostRequestInformation(SendActivityNotificationRequestBody $body, ?array $headers = null, ?array $options = null): RequestInformation {
     ...
     * @return Promise
    */
    public function post(SendActivityNotificationRequestBody $body, ?array $headers = null, ?array $options = null, ?ResponseHandler $responseHandler = null): Promise {
