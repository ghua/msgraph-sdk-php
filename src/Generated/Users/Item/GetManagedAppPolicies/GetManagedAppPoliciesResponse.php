...
class GetManagedAppPoliciesResponse implements AdditionalDataHolder, Parsable 
{
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): GetManagedAppPoliciesResponse {
