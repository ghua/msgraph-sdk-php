...
class StopHoldMusicRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return StopHoldMusicRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): StopHoldMusicRequestBody {
