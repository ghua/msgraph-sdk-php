...
class MuteRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return MuteRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): MuteRequestBody {
