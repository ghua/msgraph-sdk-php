...
class CancelMediaProcessingRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return CancelMediaProcessingRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): CancelMediaProcessingRequestBody {
