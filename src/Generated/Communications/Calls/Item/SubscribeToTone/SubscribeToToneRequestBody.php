...
class SubscribeToToneRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return SubscribeToToneRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): SubscribeToToneRequestBody {
