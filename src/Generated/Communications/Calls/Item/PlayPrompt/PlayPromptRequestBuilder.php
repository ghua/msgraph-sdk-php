...
class PlayPromptRequestBuilder 
{
    ...
    */
     ...
     * @param PlayPromptRequestBody $body 
     * @param array<string, mixed>|null $headers Request headers
     * @param array<string, RequestOption>|null $options Request options
     * @return RequestInformation
    */
    public function createPostRequestInformation(PlayPromptRequestBody $body, ?array $headers = null, ?array $options = null): RequestInformation {
     ...
     * @return Promise
    */
    public function post(PlayPromptRequestBody $body, ?array $headers = null, ?array $options = null, ?ResponseHandler $responseHandler = null): Promise {
        $requestInfo = $this->createPostRequestInformation($body, $headers, $options);
        try {
            return $this->requestAdapter->sendAsync($requestInfo, PlayPromptOperation::class, $responseHandler);
        } catch(Exception $ex) {
