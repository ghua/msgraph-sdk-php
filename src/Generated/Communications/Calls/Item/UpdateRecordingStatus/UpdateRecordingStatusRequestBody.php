...
class UpdateRecordingStatusRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return UpdateRecordingStatusRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): UpdateRecordingStatusRequestBody {
