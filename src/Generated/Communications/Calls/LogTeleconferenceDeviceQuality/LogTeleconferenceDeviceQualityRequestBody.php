...
class LogTeleconferenceDeviceQualityRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return LogTeleconferenceDeviceQualityRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): LogTeleconferenceDeviceQualityRequestBody {
