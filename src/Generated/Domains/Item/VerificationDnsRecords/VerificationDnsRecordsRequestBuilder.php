...
class VerificationDnsRecordsRequestBuilder 
{
    ...
    */
     ...
     * @return RequestInformation
    */
    public function createPostRequestInformation(DomainDnsRecord $body, ?array $headers = null, ?array $options = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = $this->urlTemplate;
        $requestInfo->pathParameters = $this->pathParameters;
    ...
    */
    public function get(?array $queryParameters = null, ?array $headers = null, ?array $options = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            return $this->requestAdapter->sendAsync($requestInfo, DomainDnsRecordCollectionResponse::class, $responseHandler);
        } catch(Exception $ex) {
     ...
     * @return Promise
    */
    public function post(DomainDnsRecord $body, ?array $headers = null, ?array $options = null, ?ResponseHandler $responseHandler = null): Promise {
