...
class GetFinalAttachmentResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /**
     * Instantiates a new getFinalAttachmentResponse and sets the default values.
    */
     ...
     * @return GetFinalAttachmentResponse
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): GetFinalAttachmentResponse {
