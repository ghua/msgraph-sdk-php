...
class GetMemberObjectsResponse implements AdditionalDataHolder, Parsable 
{
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): GetMemberObjectsResponse {
