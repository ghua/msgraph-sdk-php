...
namespace Microsoft\Graph\Generated\Groups\Item\CalendarView\Item\Instances\Item\SingleValueExtendedProperties\Count;
...
class CountRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/groups/{group%2Did}/calendarView/{event%2Did}/instances/{event%2Did1}/singleValueExtendedProperties/$count';
