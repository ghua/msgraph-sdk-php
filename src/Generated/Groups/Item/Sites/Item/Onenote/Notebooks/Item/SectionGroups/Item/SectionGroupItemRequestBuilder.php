...
class SectionGroupItemRequestBuilder 
{
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Generated.groups.item.sites.item.onenote.notebooks.item.sectionGroups.item.sectionGroups.item collection
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Generated.groups.item.sites.item.onenote.notebooks.item.sectionGroups.item.sections.item collection
     * @param string $id Unique identifier of the item
