...
namespace Microsoft\Graph\Generated\Groups\Item\Sites\Item\Lists\Item\Items\Item;

use Exception;
use Http\Promise\Promise;
use Http\Promise\RejectedPromise;
use Microsoft\Graph\Generated\Groups\Item\Sites\Item\Lists\Item\Items\Item\Analytics\AnalyticsRequestBuilder;
...
class ListItemItemRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/items/{listItem%2Did}{?%24select,%24expand}';
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Generated.groups.item.sites.item.lists.item.items.item.versions.item collection
