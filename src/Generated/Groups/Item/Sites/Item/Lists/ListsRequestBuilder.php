...
namespace Microsoft\Graph\Generated\Groups\Item\Sites\Item\Lists;

use Exception;
use Http\Promise\Promise;
use Http\Promise\RejectedPromise;
use Microsoft\Graph\Generated\Groups\Item\Sites\Item\Lists\Count\CountRequestBuilder;
...
class ListsRequestBuilder 
{
    ...
    */
     ...
     * @return RequestInformation
    */
    public function createPostRequestInformation(EscapedList $body, ?array $headers = null, ?array $options = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = $this->urlTemplate;
        $requestInfo->pathParameters = $this->pathParameters;
    ...
    */
    public function get(?array $queryParameters = null, ?array $headers = null, ?array $options = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            return $this->requestAdapter->sendAsync($requestInfo, ListCollectionResponse::class, $responseHandler);
        } catch(Exception $ex) {
     ...
     * @return Promise
    */
    public function post(EscapedList $body, ?array $headers = null, ?array $options = null, ?ResponseHandler $responseHandler = null): Promise {
