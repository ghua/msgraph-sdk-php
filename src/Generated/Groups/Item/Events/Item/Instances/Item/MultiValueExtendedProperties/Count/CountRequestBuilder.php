...
namespace Microsoft\Graph\Generated\Groups\Item\Events\Item\Instances\Item\MultiValueExtendedProperties\Count;
...
class CountRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/groups/{group%2Did}/events/{event%2Did}/instances/{event%2Did1}/multiValueExtendedProperties/$count';
