...
class ChannelItemRequestBuilder 
{
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Generated.groups.item.team.channels.item.members.item collection
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Generated.groups.item.team.channels.item.messages.item collection
     * @param string $id Unique identifier of the item
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Generated.groups.item.team.channels.item.tabs.item collection
     * @param string $id Unique identifier of the item
