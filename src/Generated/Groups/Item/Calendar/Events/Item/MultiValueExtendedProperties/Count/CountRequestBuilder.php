...
namespace Microsoft\Graph\Generated\Groups\Item\Calendar\Events\Item\MultiValueExtendedProperties\Count;
...
class CountRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/groups/{group%2Did}/calendar/events/{event%2Did}/multiValueExtendedProperties/$count';
