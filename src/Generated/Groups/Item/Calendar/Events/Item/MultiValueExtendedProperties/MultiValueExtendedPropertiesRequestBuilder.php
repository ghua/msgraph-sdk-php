...
namespace Microsoft\Graph\Generated\Groups\Item\Calendar\Events\Item\MultiValueExtendedProperties;

use Exception;
use Http\Promise\Promise;
use Http\Promise\RejectedPromise;
use Microsoft\Graph\Generated\Groups\Item\Calendar\Events\Item\MultiValueExtendedProperties\Count\CountRequestBuilder;
...
class MultiValueExtendedPropertiesRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/groups/{group%2Did}/calendar/events/{event%2Did}/multiValueExtendedProperties{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}';
