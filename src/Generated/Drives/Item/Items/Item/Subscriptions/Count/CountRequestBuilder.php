...
namespace Microsoft\Graph\Generated\Drives\Item\Items\Item\Subscriptions\Count;
...
class CountRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/subscriptions/$count';
