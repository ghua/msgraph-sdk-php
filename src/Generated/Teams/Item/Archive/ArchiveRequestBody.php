...
class ArchiveRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): ArchiveRequestBody {
    ...
    */
    public function getFieldDeserializers(): array {
        $currentObject = $this;
        return  [
            'shouldSetSpoSiteReadOnlyForMembers' => function (ParseNode $n) use ($currentObject) { $currentObject->setShouldSetSpoSiteReadOnlyForMembers($n->getBooleanValue()); },
        ];
    }
