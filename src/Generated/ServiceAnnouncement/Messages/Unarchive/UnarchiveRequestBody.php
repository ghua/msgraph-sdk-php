...
class UnarchiveRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return UnarchiveRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): UnarchiveRequestBody {
