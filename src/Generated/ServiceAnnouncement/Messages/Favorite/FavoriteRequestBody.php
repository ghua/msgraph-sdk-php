...
class FavoriteRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return FavoriteRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): FavoriteRequestBody {
