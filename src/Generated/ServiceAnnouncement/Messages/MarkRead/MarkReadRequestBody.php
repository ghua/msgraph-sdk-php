...
class MarkReadRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return MarkReadRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): MarkReadRequestBody {
