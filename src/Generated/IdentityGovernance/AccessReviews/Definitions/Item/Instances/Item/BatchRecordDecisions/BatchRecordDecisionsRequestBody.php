...
class BatchRecordDecisionsRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return BatchRecordDecisionsRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): BatchRecordDecisionsRequestBody {
