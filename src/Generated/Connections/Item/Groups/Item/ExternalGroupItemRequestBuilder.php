...
class ExternalGroupItemRequestBuilder 
{
    ...
    */
     ...
     * @return RequestInformation
    */
    public function createPatchRequestInformation(ExternalGroup $body, ?array $headers = null, ?array $options = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = $this->urlTemplate;
        $requestInfo->pathParameters = $this->pathParameters;
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Generated.connections.item.groups.item.members.item collection
    ...
    */
     ...
     * @return Promise
    */
    public function patch(ExternalGroup $body, ?array $headers = null, ?array $options = null, ?ResponseHandler $responseHandler = null): Promise {
