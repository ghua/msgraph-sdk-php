...
class RemoveRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return RemoveRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): RemoveRequestBody {
    ...
    */
    public function getFieldDeserializers(): array {
        $currentObject = $this;
        return  [
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(Site::class)); },
        ];
    }
