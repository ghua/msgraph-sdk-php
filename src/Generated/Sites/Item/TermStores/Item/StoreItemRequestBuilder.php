...
class StoreItemRequestBuilder 
{
    ...
    */
     ...
     * @return RequestInformation
    */
    public function createPatchRequestInformation(Store $body, ?array $headers = null, ?array $options = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = $this->urlTemplate;
        $requestInfo->pathParameters = $this->pathParameters;
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Generated.sites.item.termStores.item.groups.item collection
    ...
    */
     ...
     * @return Promise
    */
    public function patch(Store $body, ?array $headers = null, ?array $options = null, ?ResponseHandler $responseHandler = null): Promise {
    ...
    /**
     * Gets an item from the Microsoft\Graph\Generated.sites.item.termStores.item.sets.item collection
     * @param string $id Unique identifier of the item
