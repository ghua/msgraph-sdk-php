...
namespace Microsoft\Graph\Generated\Sites\Item\TermStore\Groups\Item\Sets\Item\Terms\Item;
...
class TermItemRequestBuilder 
{
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Generated.sites.item.termStore.groups.item.sets.item.terms.item.children.item collection
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Generated.sites.item.termStore.groups.item.sets.item.terms.item.relations.item collection
     * @param string $id Unique identifier of the item
