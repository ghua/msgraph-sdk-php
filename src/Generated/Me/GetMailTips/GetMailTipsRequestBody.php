...
class GetMailTipsRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return GetMailTipsRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): GetMailTipsRequestBody {
