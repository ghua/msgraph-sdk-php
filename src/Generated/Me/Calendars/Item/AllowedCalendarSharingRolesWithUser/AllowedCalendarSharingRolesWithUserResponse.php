...
namespace Microsoft\Graph\Generated\Me\Calendars\Item\AllowedCalendarSharingRolesWithUser;
...
class AllowedCalendarSharingRolesWithUserResponse implements AdditionalDataHolder, Parsable 
{
    ...
    */
    public function getFieldDeserializers(): array {
        $currentObject = $this;
        return  [
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfEnumValues(CalendarRoleType::class)); },
        ];
    }
