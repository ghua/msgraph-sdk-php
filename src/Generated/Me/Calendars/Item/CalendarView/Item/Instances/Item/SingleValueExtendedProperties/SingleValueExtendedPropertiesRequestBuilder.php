...
namespace Microsoft\Graph\Generated\Me\Calendars\Item\CalendarView\Item\Instances\Item\SingleValueExtendedProperties;

use Exception;
use Http\Promise\Promise;
use Http\Promise\RejectedPromise;
use Microsoft\Graph\Generated\Me\Calendars\Item\CalendarView\Item\Instances\Item\SingleValueExtendedProperties\Count\CountRequestBuilder;
...
class SingleValueExtendedPropertiesRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/me/calendars/{calendar%2Did}/calendarView/{event%2Did}/instances/{event%2Did1}/singleValueExtendedProperties{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}';
