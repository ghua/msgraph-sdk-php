...
class CopyRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): CopyRequestBody {
    ...
    */
    public function getFieldDeserializers(): array {
        $currentObject = $this;
        return  [
            'destinationId' => function (ParseNode $n) use ($currentObject) { $currentObject->setDestinationId($n->getStringValue()); },
        ];
    }
