...
use Microsoft\Graph\Generated\Me\MailFolders\Item\ChildFolders\Item\Messages\Item\CalendarSharingMessage\CalendarSharingMessageRequestBuilder;
...
class MessageItemRequestBuilder 
{
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Generated.me.mailFolders.item.childFolders.item.messages.item.attachments.item collection
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Generated.me.mailFolders.item.childFolders.item.messages.item.extensions.item collection
     * @param string $id Unique identifier of the item
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Generated.me.mailFolders.item.childFolders.item.messages.item.multiValueExtendedProperties.item collection
     * @param string $id Unique identifier of the item
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph\Generated.me.mailFolders.item.childFolders.item.messages.item.singleValueExtendedProperties.item collection
     * @param string $id Unique identifier of the item
