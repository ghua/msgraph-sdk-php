...
namespace Microsoft\Graph\Generated\Me\JoinedTeams\Item\Channels\Item\ProvisionEmail;
...
class ProvisionEmailRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/me/joinedTeams/{team%2Did}/channels/{channel%2Did}/microsoft.graph.provisionEmail';
    ...
    */
    public function post(?array $headers = null, ?array $options = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            return $this->requestAdapter->sendAsync($requestInfo, ProvisionChannelEmailResult::class, $responseHandler);
        } catch(Exception $ex) {
