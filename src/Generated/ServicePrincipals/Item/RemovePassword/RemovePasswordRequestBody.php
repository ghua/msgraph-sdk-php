...
class RemovePasswordRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return RemovePasswordRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): RemovePasswordRequestBody {
