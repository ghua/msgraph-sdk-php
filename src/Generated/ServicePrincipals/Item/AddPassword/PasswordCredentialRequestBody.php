...
class PasswordCredentialRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return PasswordCredentialRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): PasswordCredentialRequestBody {
