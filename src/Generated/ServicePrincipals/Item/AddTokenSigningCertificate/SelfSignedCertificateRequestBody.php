...
class SelfSignedCertificateRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return SelfSignedCertificateRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): SelfSignedCertificateRequestBody {
