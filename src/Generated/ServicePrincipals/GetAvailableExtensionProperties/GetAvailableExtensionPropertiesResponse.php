...
namespace Microsoft\Graph\Generated\ServicePrincipals\GetAvailableExtensionProperties;
...
class GetAvailableExtensionPropertiesResponse implements AdditionalDataHolder, Parsable 
{
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): GetAvailableExtensionPropertiesResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        $currentObject = $this;
        return  [
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(ExtensionProperty::class)); },
        ];
    }
