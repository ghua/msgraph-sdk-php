...
class CheckMemberObjectsRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return CheckMemberObjectsRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): CheckMemberObjectsRequestBody {
