...
class GetMemberGroupsRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return GetMemberGroupsRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): GetMemberGroupsRequestBody {
    ...
    */
    public function getFieldDeserializers(): array {
        $currentObject = $this;
        return  [
            'securityEnabledOnly' => function (ParseNode $n) use ($currentObject) { $currentObject->setSecurityEnabledOnly($n->getBooleanValue()); },
        ];
    }
