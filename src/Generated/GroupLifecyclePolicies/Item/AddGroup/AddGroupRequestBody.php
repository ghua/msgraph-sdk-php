...
class AddGroupRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return AddGroupRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): AddGroupRequestBody {
