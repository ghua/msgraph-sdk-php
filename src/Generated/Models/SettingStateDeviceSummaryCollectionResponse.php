...
class SettingStateDeviceSummaryCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<SettingStateDeviceSummary>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): SettingStateDeviceSummaryCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(SettingStateDeviceSummary::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<SettingStateDeviceSummary>|null $value Value to set for the value property.
    */
