...
class HomeRealmDiscoveryPolicyCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<HomeRealmDiscoveryPolicy>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): HomeRealmDiscoveryPolicyCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(HomeRealmDiscoveryPolicy::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<HomeRealmDiscoveryPolicy>|null $value Value to set for the value property.
    */
