...
class CallCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<Call>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): CallCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(Call::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<Call>|null $value Value to set for the value property.
    */
