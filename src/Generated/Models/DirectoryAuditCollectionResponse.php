...
class DirectoryAuditCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<DirectoryAudit>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): DirectoryAuditCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(DirectoryAudit::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<DirectoryAudit>|null $value Value to set for the value property.
    */
