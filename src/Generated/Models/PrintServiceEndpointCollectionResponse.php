...
class PrintServiceEndpointCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<PrintServiceEndpoint>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): PrintServiceEndpointCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(PrintServiceEndpoint::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<PrintServiceEndpoint>|null $value Value to set for the value property.
    */
