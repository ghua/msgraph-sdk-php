...
class IdentityProviderCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<IdentityProvider>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): IdentityProviderCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(IdentityProvider::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<IdentityProvider>|null $value Value to set for the value property.
    */
