...
class PersonCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<Person>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): PersonCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(Person::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<Person>|null $value Value to set for the value property.
    */
