...
class OpenShiftChangeRequestCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<OpenShiftChangeRequest>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): OpenShiftChangeRequestCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(OpenShiftChangeRequest::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<OpenShiftChangeRequest>|null $value Value to set for the value property.
    */
