...
class ServicePrincipalCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<ServicePrincipal>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): ServicePrincipalCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(ServicePrincipal::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<ServicePrincipal>|null $value Value to set for the value property.
    */
