...
class BookingCurrencyCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<BookingCurrency>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): BookingCurrencyCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(BookingCurrency::class)); },
        ];
    }
