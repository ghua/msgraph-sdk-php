...
class AgreementFileLocalizationCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<AgreementFileLocalization>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): AgreementFileLocalizationCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(AgreementFileLocalization::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<AgreementFileLocalization>|null $value Value to set for the value property.
    */
