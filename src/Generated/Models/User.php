...
class User extends DirectoryObject 
{
    ...
    /** @var array<AssignedLicense>|null $assignedLicenses The licenses that are assigned to the user, including inherited (group-based) licenses.  Not nullable. Returned only on $select. Supports $filter (eq and not). */
    ...
    /** @var array<Extension>|null $extensions The collection of open extensions defined for the user. Read-only. Nullable. */
    ...
    /** @var bool|null $onPremisesSyncEnabled true if this object is synced from an on-premises directory; false if this object was originally synced from an on-premises directory but is no longer synced; null if this object has never been synced from an on-premises directory (default). Read-only. Returned only on $select. Supports $filter (eq, ne, not, in, and eq on null values). */
    ...
    /** @var array<string>|null $otherMails A list of additional email addresses for the user; for example: ['bob@contoso.com', 'Robert@fabrikam.com']. NOTE: This property cannot contain accent characters. Returned only on $select. Supports $filter (eq, not, ge, le, in, startsWith). */
    private ?array $otherMails = null;
    
    /** @var OutlookUser|null $outlook Read-only. */
    ...
    /** @var bool|null $showInAddressList true if the Outlook global address list should contain this user, otherwise false. If not set, this will be treated as true. For users invited through the invitation manager, this property will be set to false. Returned only on $select. Supports $filter (eq, ne, not, in). */
    ...
    */
     ...
     * @return User
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): User {
        return new User();
    }
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            'aboutMe' => function (ParseNode $n) use ($currentObject) { $currentObject->setAboutMe($n->getStringValue()); },
            'accountEnabled' => function (ParseNode $n) use ($currentObject) { $currentObject->setAccountEnabled($n->getBooleanValue()); },
            'activities' => function (ParseNode $n) use ($currentObject) { $currentObject->setActivities($n->getCollectionOfObjectValues(UserActivity::class)); },
            'ageGroup' => function (ParseNode $n) use ($currentObject) { $currentObject->setAgeGroup($n->getStringValue()); },
            ...
            'authentication' => function (ParseNode $n) use ($currentObject) { $currentObject->setAuthentication($n->getObjectValue(Authentication::class)); },
            'birthday' => function (ParseNode $n) use ($currentObject) { $currentObject->setBirthday($n->getDateTimeValue()); },
            ...
            'calendarGroups' => function (ParseNode $n) use ($currentObject) { $currentObject->setCalendarGroups($n->getCollectionOfObjectValues(CalendarGroup::class)); },
            ...
            'chats' => function (ParseNode $n) use ($currentObject) { $currentObject->setChats($n->getCollectionOfObjectValues(Chat::class)); },
            ...
            'consentProvidedForMinor' => function (ParseNode $n) use ($currentObject) { $currentObject->setConsentProvidedForMinor($n->getStringValue()); },
            'contactFolders' => function (ParseNode $n) use ($currentObject) { $currentObject->setContactFolders($n->getCollectionOfObjectValues(ContactFolder::class)); },
            'contacts' => function (ParseNode $n) use ($currentObject) { $currentObject->setContacts($n->getCollectionOfObjectValues(Contact::class)); },
            'country' => function (ParseNode $n) use ($currentObject) { $currentObject->setCountry($n->getStringValue()); },
            'createdDateTime' => function (ParseNode $n) use ($currentObject) { $currentObject->setCreatedDateTime($n->getDateTimeValue()); },
            'createdObjects' => function (ParseNode $n) use ($currentObject) { $currentObject->setCreatedObjects($n->getCollectionOfObjectValues(DirectoryObject::class)); },
            'creationType' => function (ParseNode $n) use ($currentObject) { $currentObject->setCreationType($n->getStringValue()); },
            'department' => function (ParseNode $n) use ($currentObject) { $currentObject->setDepartment($n->getStringValue()); },
            'deviceEnrollmentLimit' => function (ParseNode $n) use ($currentObject) { $currentObject->setDeviceEnrollmentLimit($n->getIntegerValue()); },
            'deviceManagementTroubleshootingEvents' => function (ParseNode $n) use ($currentObject) { $currentObject->setDeviceManagementTroubleshootingEvents($n->getCollectionOfObjectValues(DeviceManagementTroubleshootingEvent::class)); },
            ...
            'employeeHireDate' => function (ParseNode $n) use ($currentObject) { $currentObject->setEmployeeHireDate($n->getDateTimeValue()); },
            'employeeId' => function (ParseNode $n) use ($currentObject) { $currentObject->setEmployeeId($n->getStringValue()); },
            'employeeOrgData' => function (ParseNode $n) use ($currentObject) { $currentObject->setEmployeeOrgData($n->getObjectValue(EmployeeOrgData::class)); },
            'employeeType' => function (ParseNode $n) use ($currentObject) { $currentObject->setEmployeeType($n->getStringValue()); },
            ...
            'externalUserState' => function (ParseNode $n) use ($currentObject) { $currentObject->setExternalUserState($n->getStringValue()); },
            'externalUserStateChangeDateTime' => function (ParseNode $n) use ($currentObject) { $currentObject->setExternalUserStateChangeDateTime($n->getDateTimeValue()); },
            'faxNumber' => function (ParseNode $n) use ($currentObject) { $currentObject->setFaxNumber($n->getStringValue()); },
            'followedSites' => function (ParseNode $n) use ($currentObject) { $currentObject->setFollowedSites($n->getCollectionOfObjectValues(Site::class)); },
            'givenName' => function (ParseNode $n) use ($currentObject) { $currentObject->setGivenName($n->getStringValue()); },
            'hireDate' => function (ParseNode $n) use ($currentObject) { $currentObject->setHireDate($n->getDateTimeValue()); },
            'identities' => function (ParseNode $n) use ($currentObject) { $currentObject->setIdentities($n->getCollectionOfObjectValues(ObjectIdentity::class)); },
            'imAddresses' => function (ParseNode $n) use ($currentObject) { $currentObject->setImAddresses($n->getCollectionOfPrimitiveValues()); },
            'inferenceClassification' => function (ParseNode $n) use ($currentObject) { $currentObject->setInferenceClassification($n->getObjectValue(InferenceClassification::class)); },
            'insights' => function (ParseNode $n) use ($currentObject) { $currentObject->setInsights($n->getObjectValue(OfficeGraphInsights::class)); },
            'interests' => function (ParseNode $n) use ($currentObject) { $currentObject->setInterests($n->getCollectionOfPrimitiveValues()); },
            'isResourceAccount' => function (ParseNode $n) use ($currentObject) { $currentObject->setIsResourceAccount($n->getBooleanValue()); },
            'jobTitle' => function (ParseNode $n) use ($currentObject) { $currentObject->setJobTitle($n->getStringValue()); },
            'joinedTeams' => function (ParseNode $n) use ($currentObject) { $currentObject->setJoinedTeams($n->getCollectionOfObjectValues(Team::class)); },
            'lastPasswordChangeDateTime' => function (ParseNode $n) use ($currentObject) { $currentObject->setLastPasswordChangeDateTime($n->getDateTimeValue()); },
            'legalAgeGroupClassification' => function (ParseNode $n) use ($currentObject) { $currentObject->setLegalAgeGroupClassification($n->getStringValue()); },
            'licenseAssignmentStates' => function (ParseNode $n) use ($currentObject) { $currentObject->setLicenseAssignmentStates($n->getCollectionOfObjectValues(LicenseAssignmentState::class)); },
            'licenseDetails' => function (ParseNode $n) use ($currentObject) { $currentObject->setLicenseDetails($n->getCollectionOfObjectValues(LicenseDetails::class)); },
            'mail' => function (ParseNode $n) use ($currentObject) { $currentObject->setMail($n->getStringValue()); },
            'mailboxSettings' => function (ParseNode $n) use ($currentObject) { $currentObject->setMailboxSettings($n->getObjectValue(MailboxSettings::class)); },
            'mailFolders' => function (ParseNode $n) use ($currentObject) { $currentObject->setMailFolders($n->getCollectionOfObjectValues(MailFolder::class)); },
            ...
            'mySite' => function (ParseNode $n) use ($currentObject) { $currentObject->setMySite($n->getStringValue()); },
            'oauth2PermissionGrants' => function (ParseNode $n) use ($currentObject) { $currentObject->setOauth2PermissionGrants($n->getCollectionOfObjectValues(OAuth2PermissionGrant::class)); },
            ...
            'onPremisesDistinguishedName' => function (ParseNode $n) use ($currentObject) { $currentObject->setOnPremisesDistinguishedName($n->getStringValue()); },
            'onPremisesDomainName' => function (ParseNode $n) use ($currentObject) { $currentObject->setOnPremisesDomainName($n->getStringValue()); },
            'onPremisesExtensionAttributes' => function (ParseNode $n) use ($currentObject) { $currentObject->setOnPremisesExtensionAttributes($n->getObjectValue(OnPremisesExtensionAttributes::class)); },
            'onPremisesImmutableId' => function (ParseNode $n) use ($currentObject) { $currentObject->setOnPremisesImmutableId($n->getStringValue()); },
            ...
            'onPremisesUserPrincipalName' => function (ParseNode $n) use ($currentObject) { $currentObject->setOnPremisesUserPrincipalName($n->getStringValue()); },
            'otherMails' => function (ParseNode $n) use ($currentObject) { $currentObject->setOtherMails($n->getCollectionOfPrimitiveValues()); },
            'outlook' => function (ParseNode $n) use ($currentObject) { $currentObject->setOutlook($n->getObjectValue(OutlookUser::class)); },
            'ownedDevices' => function (ParseNode $n) use ($currentObject) { $currentObject->setOwnedDevices($n->getCollectionOfObjectValues(DirectoryObject::class)); },
            'ownedObjects' => function (ParseNode $n) use ($currentObject) { $currentObject->setOwnedObjects($n->getCollectionOfObjectValues(DirectoryObject::class)); },
            ...
            'pastProjects' => function (ParseNode $n) use ($currentObject) { $currentObject->setPastProjects($n->getCollectionOfPrimitiveValues()); },
            'people' => function (ParseNode $n) use ($currentObject) { $currentObject->setPeople($n->getCollectionOfObjectValues(Person::class)); },
            ...
            'planner' => function (ParseNode $n) use ($currentObject) { $currentObject->setPlanner($n->getObjectValue(PlannerUser::class)); },
            ...
            'preferredName' => function (ParseNode $n) use ($currentObject) { $currentObject->setPreferredName($n->getStringValue()); },
            'presence' => function (ParseNode $n) use ($currentObject) { $currentObject->setPresence($n->getObjectValue(Presence::class)); },
            ...
            'registeredDevices' => function (ParseNode $n) use ($currentObject) { $currentObject->setRegisteredDevices($n->getCollectionOfObjectValues(DirectoryObject::class)); },
            'responsibilities' => function (ParseNode $n) use ($currentObject) { $currentObject->setResponsibilities($n->getCollectionOfPrimitiveValues()); },
            'schools' => function (ParseNode $n) use ($currentObject) { $currentObject->setSchools($n->getCollectionOfPrimitiveValues()); },
            'scopedRoleMemberOf' => function (ParseNode $n) use ($currentObject) { $currentObject->setScopedRoleMemberOf($n->getCollectionOfObjectValues(ScopedRoleMembership::class)); },
            'settings' => function (ParseNode $n) use ($currentObject) { $currentObject->setSettings($n->getObjectValue(UserSettings::class)); },
            'showInAddressList' => function (ParseNode $n) use ($currentObject) { $currentObject->setShowInAddressList($n->getBooleanValue()); },
            'signInSessionsValidFromDateTime' => function (ParseNode $n) use ($currentObject) { $currentObject->setSignInSessionsValidFromDateTime($n->getDateTimeValue()); },
            'skills' => function (ParseNode $n) use ($currentObject) { $currentObject->setSkills($n->getCollectionOfPrimitiveValues()); },
            ...
            'teamwork' => function (ParseNode $n) use ($currentObject) { $currentObject->setTeamwork($n->getObjectValue(UserTeamwork::class)); },
            'todo' => function (ParseNode $n) use ($currentObject) { $currentObject->setTodo($n->getObjectValue(Todo::class)); },
