...
class TokenLifetimePolicyCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<TokenLifetimePolicy>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): TokenLifetimePolicyCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(TokenLifetimePolicy::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<TokenLifetimePolicy>|null $value Value to set for the value property.
    */
