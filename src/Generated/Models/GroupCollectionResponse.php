...
class GroupCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<Group>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): GroupCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(Group::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<Group>|null $value Value to set for the value property.
    */
