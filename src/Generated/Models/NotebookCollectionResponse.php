...
class NotebookCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<Notebook>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): NotebookCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(Notebook::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<Notebook>|null $value Value to set for the value property.
    */
