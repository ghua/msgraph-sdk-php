...
class AccessPackageAssignmentRequestCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<AccessPackageAssignmentRequest>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): AccessPackageAssignmentRequestCollectionResponse {
