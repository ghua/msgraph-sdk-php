...
class AgreementFileVersionCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<AgreementFileVersion>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): AgreementFileVersionCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(AgreementFileVersion::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<AgreementFileVersion>|null $value Value to set for the value property.
    */
