...
class OnenotePageCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<OnenotePage>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): OnenotePageCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(OnenotePage::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<OnenotePage>|null $value Value to set for the value property.
    */
