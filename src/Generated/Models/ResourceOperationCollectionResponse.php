...
class ResourceOperationCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<ResourceOperation>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): ResourceOperationCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(ResourceOperation::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<ResourceOperation>|null $value Value to set for the value property.
    */
