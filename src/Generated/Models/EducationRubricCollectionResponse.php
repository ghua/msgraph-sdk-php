...
class EducationRubricCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<EducationRubric>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): EducationRubricCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(EducationRubric::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<EducationRubric>|null $value Value to set for the value property.
    */
