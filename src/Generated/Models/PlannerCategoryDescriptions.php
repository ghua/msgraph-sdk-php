    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'category10' => function (ParseNode $n) use ($currentObject) { $currentObject->setCategory10($n->getStringValue()); },
            'category11' => function (ParseNode $n) use ($currentObject) { $currentObject->setCategory11($n->getStringValue()); },
            'category12' => function (ParseNode $n) use ($currentObject) { $currentObject->setCategory12($n->getStringValue()); },
            'category13' => function (ParseNode $n) use ($currentObject) { $currentObject->setCategory13($n->getStringValue()); },
            'category14' => function (ParseNode $n) use ($currentObject) { $currentObject->setCategory14($n->getStringValue()); },
            'category15' => function (ParseNode $n) use ($currentObject) { $currentObject->setCategory15($n->getStringValue()); },
            'category16' => function (ParseNode $n) use ($currentObject) { $currentObject->setCategory16($n->getStringValue()); },
            'category17' => function (ParseNode $n) use ($currentObject) { $currentObject->setCategory17($n->getStringValue()); },
            'category18' => function (ParseNode $n) use ($currentObject) { $currentObject->setCategory18($n->getStringValue()); },
            'category19' => function (ParseNode $n) use ($currentObject) { $currentObject->setCategory19($n->getStringValue()); },
            'category2' => function (ParseNode $n) use ($currentObject) { $currentObject->setCategory2($n->getStringValue()); },
            'category20' => function (ParseNode $n) use ($currentObject) { $currentObject->setCategory20($n->getStringValue()); },
            'category21' => function (ParseNode $n) use ($currentObject) { $currentObject->setCategory21($n->getStringValue()); },
            'category22' => function (ParseNode $n) use ($currentObject) { $currentObject->setCategory22($n->getStringValue()); },
            'category23' => function (ParseNode $n) use ($currentObject) { $currentObject->setCategory23($n->getStringValue()); },
            'category24' => function (ParseNode $n) use ($currentObject) { $currentObject->setCategory24($n->getStringValue()); },
            'category25' => function (ParseNode $n) use ($currentObject) { $currentObject->setCategory25($n->getStringValue()); },
            ...
            'category7' => function (ParseNode $n) use ($currentObject) { $currentObject->setCategory7($n->getStringValue()); },
            'category8' => function (ParseNode $n) use ($currentObject) { $currentObject->setCategory8($n->getStringValue()); },
            'category9' => function (ParseNode $n) use ($currentObject) { $currentObject->setCategory9($n->getStringValue()); },
        ];
    }
