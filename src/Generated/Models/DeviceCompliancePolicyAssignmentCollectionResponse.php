...
class DeviceCompliancePolicyAssignmentCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<DeviceCompliancePolicyAssignment>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): DeviceCompliancePolicyAssignmentCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(DeviceCompliancePolicyAssignment::class)); },
        ];
    }
