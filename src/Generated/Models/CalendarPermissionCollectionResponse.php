...
class CalendarPermissionCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<CalendarPermission>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): CalendarPermissionCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(CalendarPermission::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<CalendarPermission>|null $value Value to set for the value property.
    */
