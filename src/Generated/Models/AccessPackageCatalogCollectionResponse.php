...
class AccessPackageCatalogCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<AccessPackageCatalog>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): AccessPackageCatalogCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(AccessPackageCatalog::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<AccessPackageCatalog>|null $value Value to set for the value property.
    */
