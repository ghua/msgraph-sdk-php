...
class TimeOffCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<TimeOff>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): TimeOffCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(TimeOff::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<TimeOff>|null $value Value to set for the value property.
    */
