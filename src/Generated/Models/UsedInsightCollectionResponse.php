...
class UsedInsightCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<UsedInsight>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): UsedInsightCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(UsedInsight::class)); },
        ];
    }
