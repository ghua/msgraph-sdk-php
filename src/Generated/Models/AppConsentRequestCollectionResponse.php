...
class AppConsentRequestCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<AppConsentRequest>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): AppConsentRequestCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(AppConsentRequest::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<AppConsentRequest>|null $value Value to set for the value property.
    */
