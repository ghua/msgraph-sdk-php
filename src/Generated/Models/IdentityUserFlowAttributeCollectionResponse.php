...
class IdentityUserFlowAttributeCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<IdentityUserFlowAttribute>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): IdentityUserFlowAttributeCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(IdentityUserFlowAttribute::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<IdentityUserFlowAttribute>|null $value Value to set for the value property.
    */
