    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            'attachments' => function (ParseNode $n) use ($currentObject) { $currentObject->setAttachments($n->getCollectionOfObjectValues(ChatMessageAttachment::class)); },
            'body' => function (ParseNode $n) use ($currentObject) { $currentObject->setBody($n->getObjectValue(ItemBody::class)); },
            'channelIdentity' => function (ParseNode $n) use ($currentObject) { $currentObject->setChannelIdentity($n->getObjectValue(ChannelIdentity::class)); },
            'chatId' => function (ParseNode $n) use ($currentObject) { $currentObject->setChatId($n->getStringValue()); },
            ...
            'eventDetail' => function (ParseNode $n) use ($currentObject) { $currentObject->setEventDetail($n->getObjectValue(EventMessageDetail::class)); },
            'from' => function (ParseNode $n) use ($currentObject) { $currentObject->setFrom($n->getObjectValue(ChatMessageFromIdentitySet::class)); },
            'hostedContents' => function (ParseNode $n) use ($currentObject) { $currentObject->setHostedContents($n->getCollectionOfObjectValues(ChatMessageHostedContent::class)); },
            'importance' => function (ParseNode $n) use ($currentObject) { $currentObject->setImportance($n->getEnumValue(ChatMessageImportance::class)); },
            'lastEditedDateTime' => function (ParseNode $n) use ($currentObject) { $currentObject->setLastEditedDateTime($n->getDateTimeValue()); },
            ...
            'mentions' => function (ParseNode $n) use ($currentObject) { $currentObject->setMentions($n->getCollectionOfObjectValues(ChatMessageMention::class)); },
            'messageType' => function (ParseNode $n) use ($currentObject) { $currentObject->setMessageType($n->getEnumValue(ChatMessageType::class)); },
            'policyViolation' => function (ParseNode $n) use ($currentObject) { $currentObject->setPolicyViolation($n->getObjectValue(ChatMessagePolicyViolation::class)); },
            'reactions' => function (ParseNode $n) use ($currentObject) { $currentObject->setReactions($n->getCollectionOfObjectValues(ChatMessageReaction::class)); },
            'replies' => function (ParseNode $n) use ($currentObject) { $currentObject->setReplies($n->getCollectionOfObjectValues(ChatMessage::class)); },
            'replyToId' => function (ParseNode $n) use ($currentObject) { $currentObject->setReplyToId($n->getStringValue()); },
