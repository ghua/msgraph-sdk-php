...
class UserScopeTeamsAppInstallationCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<UserScopeTeamsAppInstallation>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): UserScopeTeamsAppInstallationCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(UserScopeTeamsAppInstallation::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<UserScopeTeamsAppInstallation>|null $value Value to set for the value property.
    */
