...
class SchedulingGroupCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<SchedulingGroup>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): SchedulingGroupCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(SchedulingGroup::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<SchedulingGroup>|null $value Value to set for the value property.
    */
