...
class DomainDnsRecordCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<DomainDnsRecord>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): DomainDnsRecordCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(DomainDnsRecord::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<DomainDnsRecord>|null $value Value to set for the value property.
    */
