...
class InvitationCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<Invitation>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): InvitationCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(Invitation::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<Invitation>|null $value Value to set for the value property.
    */
