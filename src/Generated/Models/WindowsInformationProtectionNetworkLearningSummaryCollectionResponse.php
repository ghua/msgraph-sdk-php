...
class WindowsInformationProtectionNetworkLearningSummaryCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<WindowsInformationProtectionNetworkLearningSummary>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): WindowsInformationProtectionNetworkLearningSummaryCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(WindowsInformationProtectionNetworkLearningSummary::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<WindowsInformationProtectionNetworkLearningSummary>|null $value Value to set for the value property.
    */
