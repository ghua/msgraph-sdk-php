...
class DriveItemVersionCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<DriveItemVersion>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): DriveItemVersionCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(DriveItemVersion::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<DriveItemVersion>|null $value Value to set for the value property.
    */
