...
class ProvisioningObjectSummaryCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<ProvisioningObjectSummary>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): ProvisioningObjectSummaryCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(ProvisioningObjectSummary::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<ProvisioningObjectSummary>|null $value Value to set for the value property.
    */
