...
class DeviceInstallStateCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<DeviceInstallState>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): DeviceInstallStateCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(DeviceInstallState::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<DeviceInstallState>|null $value Value to set for the value property.
    */
