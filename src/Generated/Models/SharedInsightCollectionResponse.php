...
class SharedInsightCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<SharedInsight>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): SharedInsightCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(SharedInsight::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<SharedInsight>|null $value Value to set for the value property.
    */
