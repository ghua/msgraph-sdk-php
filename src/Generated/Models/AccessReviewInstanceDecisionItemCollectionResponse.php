...
class AccessReviewInstanceDecisionItemCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): AccessReviewInstanceDecisionItemCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(AccessReviewInstanceDecisionItem::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<AccessReviewInstanceDecisionItem>|null $value Value to set for the value property.
    */
