...
class ConditionalAccessPolicyCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<ConditionalAccessPolicy>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): ConditionalAccessPolicyCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(ConditionalAccessPolicy::class)); },
        ];
    }
