...
class CalendarGroupCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<CalendarGroup>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): CalendarGroupCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(CalendarGroup::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<CalendarGroup>|null $value Value to set for the value property.
    */
