...
class AudioRoutingGroupCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<AudioRoutingGroup>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): AudioRoutingGroupCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(AudioRoutingGroup::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<AudioRoutingGroup>|null $value Value to set for the value property.
    */
