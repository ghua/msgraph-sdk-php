...
class ApprovalStageCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(ApprovalStage::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<ApprovalStage>|null $value Value to set for the value property.
    */
