...
class PlannerPlanContainer implements AdditionalDataHolder, Parsable 
{
    ...
    */
    public function getFieldDeserializers(): array {
        $currentObject = $this;
        return  [
            'containerId' => function (ParseNode $n) use ($currentObject) { $currentObject->setContainerId($n->getStringValue()); },
            'type' => function (ParseNode $n) use ($currentObject) { $currentObject->setType($n->getEnumValue(PlannerContainerType::class)); },
