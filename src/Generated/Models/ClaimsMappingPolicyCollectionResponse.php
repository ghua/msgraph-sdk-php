...
class ClaimsMappingPolicyCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<ClaimsMappingPolicy>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): ClaimsMappingPolicyCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(ClaimsMappingPolicy::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<ClaimsMappingPolicy>|null $value Value to set for the value property.
    */
