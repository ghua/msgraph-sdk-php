...
class AndroidManagedAppProtectionCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<AndroidManagedAppProtection>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): AndroidManagedAppProtectionCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(AndroidManagedAppProtection::class)); },
        ];
    }
