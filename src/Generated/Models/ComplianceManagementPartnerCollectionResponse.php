...
class ComplianceManagementPartnerCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<ComplianceManagementPartner>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): ComplianceManagementPartnerCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(ComplianceManagementPartner::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<ComplianceManagementPartner>|null $value Value to set for the value property.
    */
