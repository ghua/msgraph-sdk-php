...
class Alert extends Entity 
{
    ...
    */
     ...
     * @return Alert
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): Alert {
        return new Alert();
    }
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            'activityGroupName' => function (ParseNode $n) use ($currentObject) { $currentObject->setActivityGroupName($n->getStringValue()); },
            'alertDetections' => function (ParseNode $n) use ($currentObject) { $currentObject->setAlertDetections($n->getCollectionOfObjectValues(AlertDetection::class)); },
            'assignedTo' => function (ParseNode $n) use ($currentObject) { $currentObject->setAssignedTo($n->getStringValue()); },
            'azureSubscriptionId' => function (ParseNode $n) use ($currentObject) { $currentObject->setAzureSubscriptionId($n->getStringValue()); },
            ...
            'cloudAppStates' => function (ParseNode $n) use ($currentObject) { $currentObject->setCloudAppStates($n->getCollectionOfObjectValues(CloudAppSecurityState::class)); },
            'comments' => function (ParseNode $n) use ($currentObject) { $currentObject->setComments($n->getCollectionOfPrimitiveValues()); },
            'confidence' => function (ParseNode $n) use ($currentObject) { $currentObject->setConfidence($n->getIntegerValue()); },
            ...
            'detectionIds' => function (ParseNode $n) use ($currentObject) { $currentObject->setDetectionIds($n->getCollectionOfPrimitiveValues()); },
            ...
            'fileStates' => function (ParseNode $n) use ($currentObject) { $currentObject->setFileStates($n->getCollectionOfObjectValues(FileSecurityState::class)); },
            'historyStates' => function (ParseNode $n) use ($currentObject) { $currentObject->setHistoryStates($n->getCollectionOfObjectValues(AlertHistoryState::class)); },
            'hostStates' => function (ParseNode $n) use ($currentObject) { $currentObject->setHostStates($n->getCollectionOfObjectValues(HostSecurityState::class)); },
            'incidentIds' => function (ParseNode $n) use ($currentObject) { $currentObject->setIncidentIds($n->getCollectionOfPrimitiveValues()); },
            'investigationSecurityStates' => function (ParseNode $n) use ($currentObject) { $currentObject->setInvestigationSecurityStates($n->getCollectionOfObjectValues(InvestigationSecurityState::class)); },
            'lastEventDateTime' => function (ParseNode $n) use ($currentObject) { $currentObject->setLastEventDateTime($n->getDateTimeValue()); },
            'lastModifiedDateTime' => function (ParseNode $n) use ($currentObject) { $currentObject->setLastModifiedDateTime($n->getDateTimeValue()); },
            'malwareStates' => function (ParseNode $n) use ($currentObject) { $currentObject->setMalwareStates($n->getCollectionOfObjectValues(MalwareState::class)); },
            'messageSecurityStates' => function (ParseNode $n) use ($currentObject) { $currentObject->setMessageSecurityStates($n->getCollectionOfObjectValues(MessageSecurityState::class)); },
            'networkConnections' => function (ParseNode $n) use ($currentObject) { $currentObject->setNetworkConnections($n->getCollectionOfObjectValues(NetworkConnection::class)); },
            'processes' => function (ParseNode $n) use ($currentObject) { $currentObject->setProcesses($n->getCollectionOfObjectValues(Process::class)); },
            'recommendedActions' => function (ParseNode $n) use ($currentObject) { $currentObject->setRecommendedActions($n->getCollectionOfPrimitiveValues()); },
            'registryKeyStates' => function (ParseNode $n) use ($currentObject) { $currentObject->setRegistryKeyStates($n->getCollectionOfObjectValues(RegistryKeyState::class)); },
            'securityResources' => function (ParseNode $n) use ($currentObject) { $currentObject->setSecurityResources($n->getCollectionOfObjectValues(SecurityResource::class)); },
            'severity' => function (ParseNode $n) use ($currentObject) { $currentObject->setSeverity($n->getEnumValue(AlertSeverity::class)); },
            'sourceMaterials' => function (ParseNode $n) use ($currentObject) { $currentObject->setSourceMaterials($n->getCollectionOfPrimitiveValues()); },
            ...
            'triggers' => function (ParseNode $n) use ($currentObject) { $currentObject->setTriggers($n->getCollectionOfObjectValues(AlertTrigger::class)); },
            'uriClickSecurityStates' => function (ParseNode $n) use ($currentObject) { $currentObject->setUriClickSecurityStates($n->getCollectionOfObjectValues(UriClickSecurityState::class)); },
            'userStates' => function (ParseNode $n) use ($currentObject) { $currentObject->setUserStates($n->getCollectionOfObjectValues(UserSecurityState::class)); },
            ...
            'vulnerabilityStates' => function (ParseNode $n) use ($currentObject) { $currentObject->setVulnerabilityStates($n->getCollectionOfObjectValues(VulnerabilityState::class)); },
        ]);
    }
