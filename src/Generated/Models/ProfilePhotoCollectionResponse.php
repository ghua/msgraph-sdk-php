...
class ProfilePhotoCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<ProfilePhoto>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): ProfilePhotoCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(ProfilePhoto::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<ProfilePhoto>|null $value Value to set for the value property.
    */
