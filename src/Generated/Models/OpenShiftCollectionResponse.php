...
class OpenShiftCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<OpenShift>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): OpenShiftCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(OpenShift::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<OpenShift>|null $value Value to set for the value property.
    */
