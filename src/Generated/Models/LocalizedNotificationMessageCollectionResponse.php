...
class LocalizedNotificationMessageCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<LocalizedNotificationMessage>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): LocalizedNotificationMessageCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(LocalizedNotificationMessage::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<LocalizedNotificationMessage>|null $value Value to set for the value property.
    */
