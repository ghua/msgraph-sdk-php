...
class UnifiedRoleAssignmentScheduleInstanceCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): UnifiedRoleAssignmentScheduleInstanceCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(UnifiedRoleAssignmentScheduleInstance::class)); },
        ];
    }
