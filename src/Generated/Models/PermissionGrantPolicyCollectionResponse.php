...
class PermissionGrantPolicyCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<PermissionGrantPolicy>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): PermissionGrantPolicyCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(PermissionGrantPolicy::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<PermissionGrantPolicy>|null $value Value to set for the value property.
    */
