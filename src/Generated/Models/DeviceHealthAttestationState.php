...
class DeviceHealthAttestationState implements AdditionalDataHolder, Parsable 
{
    ...
    */
    public function getFieldDeserializers(): array {
        $currentObject = $this;
        return  [
            'attestationIdentityKey' => function (ParseNode $n) use ($currentObject) { $currentObject->setAttestationIdentityKey($n->getStringValue()); },
            'bitLockerStatus' => function (ParseNode $n) use ($currentObject) { $currentObject->setBitLockerStatus($n->getStringValue()); },
            'bootAppSecurityVersion' => function (ParseNode $n) use ($currentObject) { $currentObject->setBootAppSecurityVersion($n->getStringValue()); },
            'bootDebugging' => function (ParseNode $n) use ($currentObject) { $currentObject->setBootDebugging($n->getStringValue()); },
            'bootManagerSecurityVersion' => function (ParseNode $n) use ($currentObject) { $currentObject->setBootManagerSecurityVersion($n->getStringValue()); },
            'bootManagerVersion' => function (ParseNode $n) use ($currentObject) { $currentObject->setBootManagerVersion($n->getStringValue()); },
            'bootRevisionListInfo' => function (ParseNode $n) use ($currentObject) { $currentObject->setBootRevisionListInfo($n->getStringValue()); },
            'codeIntegrity' => function (ParseNode $n) use ($currentObject) { $currentObject->setCodeIntegrity($n->getStringValue()); },
            'codeIntegrityCheckVersion' => function (ParseNode $n) use ($currentObject) { $currentObject->setCodeIntegrityCheckVersion($n->getStringValue()); },
            'codeIntegrityPolicy' => function (ParseNode $n) use ($currentObject) { $currentObject->setCodeIntegrityPolicy($n->getStringValue()); },
            'contentNamespaceUrl' => function (ParseNode $n) use ($currentObject) { $currentObject->setContentNamespaceUrl($n->getStringValue()); },
            'contentVersion' => function (ParseNode $n) use ($currentObject) { $currentObject->setContentVersion($n->getStringValue()); },
            'dataExcutionPolicy' => function (ParseNode $n) use ($currentObject) { $currentObject->setDataExcutionPolicy($n->getStringValue()); },
            'deviceHealthAttestationStatus' => function (ParseNode $n) use ($currentObject) { $currentObject->setDeviceHealthAttestationStatus($n->getStringValue()); },
            'earlyLaunchAntiMalwareDriverProtection' => function (ParseNode $n) use ($currentObject) { $currentObject->setEarlyLaunchAntiMalwareDriverProtection($n->getStringValue()); },
            'healthAttestationSupportedStatus' => function (ParseNode $n) use ($currentObject) { $currentObject->setHealthAttestationSupportedStatus($n->getStringValue()); },
            'healthStatusMismatchInfo' => function (ParseNode $n) use ($currentObject) { $currentObject->setHealthStatusMismatchInfo($n->getStringValue()); },
            'issuedDateTime' => function (ParseNode $n) use ($currentObject) { $currentObject->setIssuedDateTime($n->getDateTimeValue()); },
            'lastUpdateDateTime' => function (ParseNode $n) use ($currentObject) { $currentObject->setLastUpdateDateTime($n->getStringValue()); },
            'operatingSystemKernelDebugging' => function (ParseNode $n) use ($currentObject) { $currentObject->setOperatingSystemKernelDebugging($n->getStringValue()); },
            'operatingSystemRevListInfo' => function (ParseNode $n) use ($currentObject) { $currentObject->setOperatingSystemRevListInfo($n->getStringValue()); },
            'pcr0' => function (ParseNode $n) use ($currentObject) { $currentObject->setPcr0($n->getStringValue()); },
            'pcrHashAlgorithm' => function (ParseNode $n) use ($currentObject) { $currentObject->setPcrHashAlgorithm($n->getStringValue()); },
            'resetCount' => function (ParseNode $n) use ($currentObject) { $currentObject->setResetCount($n->getIntegerValue()); },
            'restartCount' => function (ParseNode $n) use ($currentObject) { $currentObject->setRestartCount($n->getIntegerValue()); },
            'safeMode' => function (ParseNode $n) use ($currentObject) { $currentObject->setSafeMode($n->getStringValue()); },
            'secureBoot' => function (ParseNode $n) use ($currentObject) { $currentObject->setSecureBoot($n->getStringValue()); },
            'secureBootConfigurationPolicyFingerPrint' => function (ParseNode $n) use ($currentObject) { $currentObject->setSecureBootConfigurationPolicyFingerPrint($n->getStringValue()); },
            'testSigning' => function (ParseNode $n) use ($currentObject) { $currentObject->setTestSigning($n->getStringValue()); },
            'tpmVersion' => function (ParseNode $n) use ($currentObject) { $currentObject->setTpmVersion($n->getStringValue()); },
            'virtualSecureMode' => function (ParseNode $n) use ($currentObject) { $currentObject->setVirtualSecureMode($n->getStringValue()); },
            'windowsPE' => function (ParseNode $n) use ($currentObject) { $currentObject->setWindowsPE($n->getStringValue()); },
        ];
    }
