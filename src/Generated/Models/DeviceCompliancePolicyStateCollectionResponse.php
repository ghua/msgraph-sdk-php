...
class DeviceCompliancePolicyStateCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<DeviceCompliancePolicyState>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): DeviceCompliancePolicyStateCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(DeviceCompliancePolicyState::class)); },
        ];
    }
