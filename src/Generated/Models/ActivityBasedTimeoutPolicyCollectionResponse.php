...
class ActivityBasedTimeoutPolicyCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<ActivityBasedTimeoutPolicy>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): ActivityBasedTimeoutPolicyCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(ActivityBasedTimeoutPolicy::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<ActivityBasedTimeoutPolicy>|null $value Value to set for the value property.
    */
