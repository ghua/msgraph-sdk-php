...
class TeamsAppCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<TeamsApp>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): TeamsAppCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(TeamsApp::class)); },
        ];
    }
