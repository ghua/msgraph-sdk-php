...
class TermCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<Term>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): TermCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(Term::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<Term>|null $value Value to set for the value property.
    */
