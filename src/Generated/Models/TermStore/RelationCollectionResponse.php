...
class RelationCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<Relation>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): RelationCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(Relation::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<Relation>|null $value Value to set for the value property.
    */
