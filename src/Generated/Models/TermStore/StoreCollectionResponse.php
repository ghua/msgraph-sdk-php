...
class StoreCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<Store>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): StoreCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(Store::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<Store>|null $value Value to set for the value property.
    */
