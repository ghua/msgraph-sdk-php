...
class DeviceConfigurationAssignmentCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): DeviceConfigurationAssignmentCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(DeviceConfigurationAssignment::class)); },
        ];
    }
