...
class ResourceSpecificPermissionGrantCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): ResourceSpecificPermissionGrantCollectionResponse {
