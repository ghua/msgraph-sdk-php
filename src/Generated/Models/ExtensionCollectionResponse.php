...
class ExtensionCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<Extension>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): ExtensionCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(Extension::class)); },
        ];
    }
