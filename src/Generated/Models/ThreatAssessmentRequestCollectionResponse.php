...
class ThreatAssessmentRequestCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<ThreatAssessmentRequest>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): ThreatAssessmentRequestCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(ThreatAssessmentRequest::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<ThreatAssessmentRequest>|null $value Value to set for the value property.
    */
