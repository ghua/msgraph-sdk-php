...
class IdentityUserFlowAttributeAssignmentCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<IdentityUserFlowAttributeAssignment>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): IdentityUserFlowAttributeAssignmentCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(IdentityUserFlowAttributeAssignment::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<IdentityUserFlowAttributeAssignment>|null $value Value to set for the value property.
    */
