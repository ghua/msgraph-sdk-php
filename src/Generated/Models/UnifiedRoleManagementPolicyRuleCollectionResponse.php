...
class UnifiedRoleManagementPolicyRuleCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<UnifiedRoleManagementPolicyRule>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): UnifiedRoleManagementPolicyRuleCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(UnifiedRoleManagementPolicyRule::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<UnifiedRoleManagementPolicyRule>|null $value Value to set for the value property.
    */
