...
class ServiceHealthCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<ServiceHealth>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): ServiceHealthCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(ServiceHealth::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<ServiceHealth>|null $value Value to set for the value property.
    */
