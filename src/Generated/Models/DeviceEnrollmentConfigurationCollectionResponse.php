...
class DeviceEnrollmentConfigurationCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): DeviceEnrollmentConfigurationCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(DeviceEnrollmentConfiguration::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<DeviceEnrollmentConfiguration>|null $value Value to set for the value property.
    */
