    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            'activatedUsing' => function (ParseNode $n) use ($currentObject) { $currentObject->setActivatedUsing($n->getObjectValue(UnifiedRoleEligibilityScheduleInstance::class)); },
            'assignmentType' => function (ParseNode $n) use ($currentObject) { $currentObject->setAssignmentType($n->getStringValue()); },
            'endDateTime' => function (ParseNode $n) use ($currentObject) { $currentObject->setEndDateTime($n->getDateTimeValue()); },
            'memberType' => function (ParseNode $n) use ($currentObject) { $currentObject->setMemberType($n->getStringValue()); },
            'roleAssignmentOriginId' => function (ParseNode $n) use ($currentObject) { $currentObject->setRoleAssignmentOriginId($n->getStringValue()); },
            'roleAssignmentScheduleId' => function (ParseNode $n) use ($currentObject) { $currentObject->setRoleAssignmentScheduleId($n->getStringValue()); },
