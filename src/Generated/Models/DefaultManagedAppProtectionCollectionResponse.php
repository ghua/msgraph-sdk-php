...
class DefaultManagedAppProtectionCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<DefaultManagedAppProtection>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): DefaultManagedAppProtectionCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(DefaultManagedAppProtection::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<DefaultManagedAppProtection>|null $value Value to set for the value property.
    */
