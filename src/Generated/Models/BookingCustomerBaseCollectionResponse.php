...
class BookingCustomerBaseCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<BookingCustomerBase>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): BookingCustomerBaseCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(BookingCustomerBase::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<BookingCustomerBase>|null $value Value to set for the value property.
    */
