...
class TrendingCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<Trending>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): TrendingCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(Trending::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<Trending>|null $value Value to set for the value property.
    */
