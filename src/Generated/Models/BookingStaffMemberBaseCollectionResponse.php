...
class BookingStaffMemberBaseCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<BookingStaffMemberBase>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): BookingStaffMemberBaseCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(BookingStaffMemberBase::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<BookingStaffMemberBase>|null $value Value to set for the value property.
    */
