...
class SubscriptionCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<Subscription>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): SubscriptionCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(Subscription::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<Subscription>|null $value Value to set for the value property.
    */
