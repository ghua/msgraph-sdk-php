...
class GroupSettingCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<GroupSetting>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): GroupSettingCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(GroupSetting::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<GroupSetting>|null $value Value to set for the value property.
    */
