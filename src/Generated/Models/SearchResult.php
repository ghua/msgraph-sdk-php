...
class SearchResult implements AdditionalDataHolder, Parsable 
{
    ...
    */
    public function getFieldDeserializers(): array {
        $currentObject = $this;
        return  [
            'onClickTelemetryUrl' => function (ParseNode $n) use ($currentObject) { $currentObject->setOnClickTelemetryUrl($n->getStringValue()); },
        ];
    }
    ...
    */
     ...
     *  @param string|null $value Value to set for the onClickTelemetryUrl property.
    */
    public function setOnClickTelemetryUrl(?string $value ): void {
