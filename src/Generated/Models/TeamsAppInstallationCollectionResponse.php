...
class TeamsAppInstallationCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<TeamsAppInstallation>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): TeamsAppInstallationCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(TeamsAppInstallation::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<TeamsAppInstallation>|null $value Value to set for the value property.
    */
