...
class RubricCriterion implements AdditionalDataHolder, Parsable 
{
    /** @var array<string, mixed> $AdditionalData Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private array $additionalData;
    
    /** @var EducationItemBody|null $description The description of this criterion. */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): RubricCriterion {
