...
class PublicError implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return PublicError
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): PublicError {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'innerError' => function (ParseNode $n) use ($currentObject) { $currentObject->setInnerError($n->getObjectValue(PublicInnerError::class)); },
