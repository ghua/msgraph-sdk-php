...
class WindowsHelloForBusinessAuthenticationMethodCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<WindowsHelloForBusinessAuthenticationMethod>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): WindowsHelloForBusinessAuthenticationMethodCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(WindowsHelloForBusinessAuthenticationMethod::class)); },
        ];
    }
