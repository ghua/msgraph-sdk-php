...
class CommsOperationCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<CommsOperation>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): CommsOperationCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(CommsOperation::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<CommsOperation>|null $value Value to set for the value property.
    */
