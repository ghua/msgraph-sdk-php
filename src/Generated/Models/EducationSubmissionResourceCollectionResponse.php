...
class EducationSubmissionResourceCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<EducationSubmissionResource>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): EducationSubmissionResourceCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(EducationSubmissionResource::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<EducationSubmissionResource>|null $value Value to set for the value property.
    */
