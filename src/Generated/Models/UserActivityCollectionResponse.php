...
class UserActivityCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<UserActivity>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): UserActivityCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(UserActivity::class)); },
        ];
    }
