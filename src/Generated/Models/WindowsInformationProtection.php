    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'azureRightsManagementServicesAllowed' => function (ParseNode $n) use ($currentObject) { $currentObject->setAzureRightsManagementServicesAllowed($n->getBooleanValue()); },
            'dataRecoveryCertificate' => function (ParseNode $n) use ($currentObject) { $currentObject->setDataRecoveryCertificate($n->getObjectValue(WindowsInformationProtectionDataRecoveryCertificate::class)); },
            'enforcementLevel' => function (ParseNode $n) use ($currentObject) { $currentObject->setEnforcementLevel($n->getEnumValue(WindowsInformationProtectionEnforcementLevel::class)); },
            'enterpriseDomain' => function (ParseNode $n) use ($currentObject) { $currentObject->setEnterpriseDomain($n->getStringValue()); },
            'enterpriseInternalProxyServers' => function (ParseNode $n) use ($currentObject) { $currentObject->setEnterpriseInternalProxyServers($n->getCollectionOfObjectValues(WindowsInformationProtectionResourceCollection::class)); },
            'enterpriseIPRanges' => function (ParseNode $n) use ($currentObject) { $currentObject->setEnterpriseIPRanges($n->getCollectionOfObjectValues(WindowsInformationProtectionIPRangeCollection::class)); },
            'enterpriseIPRangesAreAuthoritative' => function (ParseNode $n) use ($currentObject) { $currentObject->setEnterpriseIPRangesAreAuthoritative($n->getBooleanValue()); },
            'enterpriseNetworkDomainNames' => function (ParseNode $n) use ($currentObject) { $currentObject->setEnterpriseNetworkDomainNames($n->getCollectionOfObjectValues(WindowsInformationProtectionResourceCollection::class)); },
            'enterpriseProtectedDomainNames' => function (ParseNode $n) use ($currentObject) { $currentObject->setEnterpriseProtectedDomainNames($n->getCollectionOfObjectValues(WindowsInformationProtectionResourceCollection::class)); },
            'enterpriseProxiedDomains' => function (ParseNode $n) use ($currentObject) { $currentObject->setEnterpriseProxiedDomains($n->getCollectionOfObjectValues(WindowsInformationProtectionProxiedDomainCollection::class)); },
            'enterpriseProxyServers' => function (ParseNode $n) use ($currentObject) { $currentObject->setEnterpriseProxyServers($n->getCollectionOfObjectValues(WindowsInformationProtectionResourceCollection::class)); },
            'enterpriseProxyServersAreAuthoritative' => function (ParseNode $n) use ($currentObject) { $currentObject->setEnterpriseProxyServersAreAuthoritative($n->getBooleanValue()); },
            'exemptAppLockerFiles' => function (ParseNode $n) use ($currentObject) { $currentObject->setExemptAppLockerFiles($n->getCollectionOfObjectValues(WindowsInformationProtectionAppLockerFile::class)); },
            'exemptApps' => function (ParseNode $n) use ($currentObject) { $currentObject->setExemptApps($n->getCollectionOfObjectValues(WindowsInformationProtectionApp::class)); },
            'iconsVisible' => function (ParseNode $n) use ($currentObject) { $currentObject->setIconsVisible($n->getBooleanValue()); },
            'indexingEncryptedStoresOrItemsBlocked' => function (ParseNode $n) use ($currentObject) { $currentObject->setIndexingEncryptedStoresOrItemsBlocked($n->getBooleanValue()); },
            'isAssigned' => function (ParseNode $n) use ($currentObject) { $currentObject->setIsAssigned($n->getBooleanValue()); },
            'neutralDomainResources' => function (ParseNode $n) use ($currentObject) { $currentObject->setNeutralDomainResources($n->getCollectionOfObjectValues(WindowsInformationProtectionResourceCollection::class)); },
            'protectedAppLockerFiles' => function (ParseNode $n) use ($currentObject) { $currentObject->setProtectedAppLockerFiles($n->getCollectionOfObjectValues(WindowsInformationProtectionAppLockerFile::class)); },
            'protectedApps' => function (ParseNode $n) use ($currentObject) { $currentObject->setProtectedApps($n->getCollectionOfObjectValues(WindowsInformationProtectionApp::class)); },
            'protectionUnderLockConfigRequired' => function (ParseNode $n) use ($currentObject) { $currentObject->setProtectionUnderLockConfigRequired($n->getBooleanValue()); },
            'revokeOnUnenrollDisabled' => function (ParseNode $n) use ($currentObject) { $currentObject->setRevokeOnUnenrollDisabled($n->getBooleanValue()); },
            'rightsManagementServicesTemplateId' => function (ParseNode $n) use ($currentObject) { $currentObject->setRightsManagementServicesTemplateId($n->getStringValue()); },
            'smbAutoEncryptedFileExtensions' => function (ParseNode $n) use ($currentObject) { $currentObject->setSmbAutoEncryptedFileExtensions($n->getCollectionOfObjectValues(WindowsInformationProtectionResourceCollection::class)); },
        ]);
    }
