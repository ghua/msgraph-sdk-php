...
class PrinterCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<Printer>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): PrinterCollectionResponse {
    ...
    */
     ...
     *  @param array<Printer>|null $value Value to set for the value property.
    */
