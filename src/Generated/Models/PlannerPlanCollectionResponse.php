...
class PlannerPlanCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<PlannerPlan>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): PlannerPlanCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(PlannerPlan::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<PlannerPlan>|null $value Value to set for the value property.
    */
