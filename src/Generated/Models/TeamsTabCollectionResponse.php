...
class TeamsTabCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<TeamsTab>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): TeamsTabCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(TeamsTab::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<TeamsTab>|null $value Value to set for the value property.
    */
