...
class ContactFolderCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<ContactFolder>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): ContactFolderCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(ContactFolder::class)); },
        ];
    }
