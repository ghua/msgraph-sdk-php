...
class UserFlowLanguageConfigurationCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<UserFlowLanguageConfiguration>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): UserFlowLanguageConfigurationCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(UserFlowLanguageConfiguration::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<UserFlowLanguageConfiguration>|null $value Value to set for the value property.
    */
