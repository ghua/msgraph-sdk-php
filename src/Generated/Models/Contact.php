    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            'assistantName' => function (ParseNode $n) use ($currentObject) { $currentObject->setAssistantName($n->getStringValue()); },
            'birthday' => function (ParseNode $n) use ($currentObject) { $currentObject->setBirthday($n->getDateTimeValue()); },
            'businessAddress' => function (ParseNode $n) use ($currentObject) { $currentObject->setBusinessAddress($n->getObjectValue(PhysicalAddress::class)); },
            'businessHomePage' => function (ParseNode $n) use ($currentObject) { $currentObject->setBusinessHomePage($n->getStringValue()); },
            'businessPhones' => function (ParseNode $n) use ($currentObject) { $currentObject->setBusinessPhones($n->getCollectionOfPrimitiveValues()); },
            'children' => function (ParseNode $n) use ($currentObject) { $currentObject->setChildren($n->getCollectionOfPrimitiveValues()); },
            ...
            'emailAddresses' => function (ParseNode $n) use ($currentObject) { $currentObject->setEmailAddresses($n->getCollectionOfObjectValues(EmailAddress::class)); },
            ...
            'fileAs' => function (ParseNode $n) use ($currentObject) { $currentObject->setFileAs($n->getStringValue()); },
            'generation' => function (ParseNode $n) use ($currentObject) { $currentObject->setGeneration($n->getStringValue()); },
            'givenName' => function (ParseNode $n) use ($currentObject) { $currentObject->setGivenName($n->getStringValue()); },
            'homeAddress' => function (ParseNode $n) use ($currentObject) { $currentObject->setHomeAddress($n->getObjectValue(PhysicalAddress::class)); },
            'homePhones' => function (ParseNode $n) use ($currentObject) { $currentObject->setHomePhones($n->getCollectionOfPrimitiveValues()); },
            'imAddresses' => function (ParseNode $n) use ($currentObject) { $currentObject->setImAddresses($n->getCollectionOfPrimitiveValues()); },
            'initials' => function (ParseNode $n) use ($currentObject) { $currentObject->setInitials($n->getStringValue()); },
            'jobTitle' => function (ParseNode $n) use ($currentObject) { $currentObject->setJobTitle($n->getStringValue()); },
            'manager' => function (ParseNode $n) use ($currentObject) { $currentObject->setManager($n->getStringValue()); },
            ...
            'nickName' => function (ParseNode $n) use ($currentObject) { $currentObject->setNickName($n->getStringValue()); },
            'officeLocation' => function (ParseNode $n) use ($currentObject) { $currentObject->setOfficeLocation($n->getStringValue()); },
            'otherAddress' => function (ParseNode $n) use ($currentObject) { $currentObject->setOtherAddress($n->getObjectValue(PhysicalAddress::class)); },
            'parentFolderId' => function (ParseNode $n) use ($currentObject) { $currentObject->setParentFolderId($n->getStringValue()); },
            'personalNotes' => function (ParseNode $n) use ($currentObject) { $currentObject->setPersonalNotes($n->getStringValue()); },
            ...
            'spouseName' => function (ParseNode $n) use ($currentObject) { $currentObject->setSpouseName($n->getStringValue()); },
            ...
            'yomiCompanyName' => function (ParseNode $n) use ($currentObject) { $currentObject->setYomiCompanyName($n->getStringValue()); },
            'yomiGivenName' => function (ParseNode $n) use ($currentObject) { $currentObject->setYomiGivenName($n->getStringValue()); },
            'yomiSurname' => function (ParseNode $n) use ($currentObject) { $currentObject->setYomiSurname($n->getStringValue()); },
        ]);
    }
