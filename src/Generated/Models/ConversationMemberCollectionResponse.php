...
class ConversationMemberCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<ConversationMember>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): ConversationMemberCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(ConversationMember::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<ConversationMember>|null $value Value to set for the value property.
    */
