...
class GroupLifecyclePolicyCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<GroupLifecyclePolicy>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): GroupLifecyclePolicyCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(GroupLifecyclePolicy::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<GroupLifecyclePolicy>|null $value Value to set for the value property.
    */
