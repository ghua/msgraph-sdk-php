...
class UserCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<User>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): UserCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(User::class)); },
        ];
    }
