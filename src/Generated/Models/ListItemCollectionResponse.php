...
class ListItemCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<ListItem>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): ListItemCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(ListItem::class)); },
        ];
    }
