...
class SectionGroupCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<SectionGroup>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): SectionGroupCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(SectionGroup::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<SectionGroup>|null $value Value to set for the value property.
    */
