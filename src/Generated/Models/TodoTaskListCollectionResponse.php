...
class TodoTaskListCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<TodoTaskList>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): TodoTaskListCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(TodoTaskList::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<TodoTaskList>|null $value Value to set for the value property.
    */
