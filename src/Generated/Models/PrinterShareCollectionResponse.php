...
class PrinterShareCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<PrinterShare>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): PrinterShareCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(PrinterShare::class)); },
        ];
    }
