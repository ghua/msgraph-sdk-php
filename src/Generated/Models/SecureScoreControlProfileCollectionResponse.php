...
class SecureScoreControlProfileCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<SecureScoreControlProfile>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): SecureScoreControlProfileCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(SecureScoreControlProfile::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<SecureScoreControlProfile>|null $value Value to set for the value property.
    */
