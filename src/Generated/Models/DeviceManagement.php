    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            'applePushNotificationCertificate' => function (ParseNode $n) use ($currentObject) { $currentObject->setApplePushNotificationCertificate($n->getObjectValue(ApplePushNotificationCertificate::class)); },
            'complianceManagementPartners' => function (ParseNode $n) use ($currentObject) { $currentObject->setComplianceManagementPartners($n->getCollectionOfObjectValues(ComplianceManagementPartner::class)); },
            'conditionalAccessSettings' => function (ParseNode $n) use ($currentObject) { $currentObject->setConditionalAccessSettings($n->getObjectValue(OnPremisesConditionalAccessSettings::class)); },
            'detectedApps' => function (ParseNode $n) use ($currentObject) { $currentObject->setDetectedApps($n->getCollectionOfObjectValues(DetectedApp::class)); },
            'deviceCategories' => function (ParseNode $n) use ($currentObject) { $currentObject->setDeviceCategories($n->getCollectionOfObjectValues(DeviceCategory::class)); },
            'deviceCompliancePolicies' => function (ParseNode $n) use ($currentObject) { $currentObject->setDeviceCompliancePolicies($n->getCollectionOfObjectValues(DeviceCompliancePolicy::class)); },
            'deviceCompliancePolicyDeviceStateSummary' => function (ParseNode $n) use ($currentObject) { $currentObject->setDeviceCompliancePolicyDeviceStateSummary($n->getObjectValue(DeviceCompliancePolicyDeviceStateSummary::class)); },
            'deviceCompliancePolicySettingStateSummaries' => function (ParseNode $n) use ($currentObject) { $currentObject->setDeviceCompliancePolicySettingStateSummaries($n->getCollectionOfObjectValues(DeviceCompliancePolicySettingStateSummary::class)); },
            'deviceConfigurationDeviceStateSummaries' => function (ParseNode $n) use ($currentObject) { $currentObject->setDeviceConfigurationDeviceStateSummaries($n->getObjectValue(DeviceConfigurationDeviceStateSummary::class)); },
            'deviceConfigurations' => function (ParseNode $n) use ($currentObject) { $currentObject->setDeviceConfigurations($n->getCollectionOfObjectValues(DeviceConfiguration::class)); },
            'deviceEnrollmentConfigurations' => function (ParseNode $n) use ($currentObject) { $currentObject->setDeviceEnrollmentConfigurations($n->getCollectionOfObjectValues(DeviceEnrollmentConfiguration::class)); },
            'deviceManagementPartners' => function (ParseNode $n) use ($currentObject) { $currentObject->setDeviceManagementPartners($n->getCollectionOfObjectValues(DeviceManagementPartner::class)); },
            'exchangeConnectors' => function (ParseNode $n) use ($currentObject) { $currentObject->setExchangeConnectors($n->getCollectionOfObjectValues(DeviceManagementExchangeConnector::class)); },
            ...
            'intuneAccountId' => function (ParseNode $n) use ($currentObject) { $currentObject->setIntuneAccountId($n->getStringValue()); },
            'intuneBrand' => function (ParseNode $n) use ($currentObject) { $currentObject->setIntuneBrand($n->getObjectValue(IntuneBrand::class)); },
            'iosUpdateStatuses' => function (ParseNode $n) use ($currentObject) { $currentObject->setIosUpdateStatuses($n->getCollectionOfObjectValues(IosUpdateDeviceStatus::class)); },
            'managedDeviceOverview' => function (ParseNode $n) use ($currentObject) { $currentObject->setManagedDeviceOverview($n->getObjectValue(ManagedDeviceOverview::class)); },
            ...
            'mobileThreatDefenseConnectors' => function (ParseNode $n) use ($currentObject) { $currentObject->setMobileThreatDefenseConnectors($n->getCollectionOfObjectValues(MobileThreatDefenseConnector::class)); },
            'notificationMessageTemplates' => function (ParseNode $n) use ($currentObject) { $currentObject->setNotificationMessageTemplates($n->getCollectionOfObjectValues(NotificationMessageTemplate::class)); },
            'remoteAssistancePartners' => function (ParseNode $n) use ($currentObject) { $currentObject->setRemoteAssistancePartners($n->getCollectionOfObjectValues(RemoteAssistancePartner::class)); },
            'reports' => function (ParseNode $n) use ($currentObject) { $currentObject->setReports($n->getObjectValue(DeviceManagementReports::class)); },
            'resourceOperations' => function (ParseNode $n) use ($currentObject) { $currentObject->setResourceOperations($n->getCollectionOfObjectValues(ResourceOperation::class)); },
            'roleAssignments' => function (ParseNode $n) use ($currentObject) { $currentObject->setRoleAssignments($n->getCollectionOfObjectValues(DeviceAndAppManagementRoleAssignment::class)); },
            'roleDefinitions' => function (ParseNode $n) use ($currentObject) { $currentObject->setRoleDefinitions($n->getCollectionOfObjectValues(RoleDefinition::class)); },
            'settings' => function (ParseNode $n) use ($currentObject) { $currentObject->setSettings($n->getObjectValue(DeviceManagementSettings::class)); },
            'softwareUpdateStatusSummary' => function (ParseNode $n) use ($currentObject) { $currentObject->setSoftwareUpdateStatusSummary($n->getObjectValue(SoftwareUpdateStatusSummary::class)); },
            'subscriptionState' => function (ParseNode $n) use ($currentObject) { $currentObject->setSubscriptionState($n->getEnumValue(DeviceManagementSubscriptionState::class)); },
            'telecomExpenseManagementPartners' => function (ParseNode $n) use ($currentObject) { $currentObject->setTelecomExpenseManagementPartners($n->getCollectionOfObjectValues(TelecomExpenseManagementPartner::class)); },
            'termsAndConditions' => function (ParseNode $n) use ($currentObject) { $currentObject->setTermsAndConditions($n->getCollectionOfObjectValues(TermsAndConditions::class)); },
            'troubleshootingEvents' => function (ParseNode $n) use ($currentObject) { $currentObject->setTroubleshootingEvents($n->getCollectionOfObjectValues(DeviceManagementTroubleshootingEvent::class)); },
            'windowsAutopilotDeviceIdentities' => function (ParseNode $n) use ($currentObject) { $currentObject->setWindowsAutopilotDeviceIdentities($n->getCollectionOfObjectValues(WindowsAutopilotDeviceIdentity::class)); },
            'windowsInformationProtectionAppLearningSummaries' => function (ParseNode $n) use ($currentObject) { $currentObject->setWindowsInformationProtectionAppLearningSummaries($n->getCollectionOfObjectValues(WindowsInformationProtectionAppLearningSummary::class)); },
            'windowsInformationProtectionNetworkLearningSummaries' => function (ParseNode $n) use ($currentObject) { $currentObject->setWindowsInformationProtectionNetworkLearningSummaries($n->getCollectionOfObjectValues(WindowsInformationProtectionNetworkLearningSummary::class)); },
        ]);
    }
