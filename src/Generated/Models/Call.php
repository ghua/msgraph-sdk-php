    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            'audioRoutingGroups' => function (ParseNode $n) use ($currentObject) { $currentObject->setAudioRoutingGroups($n->getCollectionOfObjectValues(AudioRoutingGroup::class)); },
            ...
            'callOptions' => function (ParseNode $n) use ($currentObject) { $currentObject->setCallOptions($n->getObjectValue(CallOptions::class)); },
            'callRoutes' => function (ParseNode $n) use ($currentObject) { $currentObject->setCallRoutes($n->getCollectionOfObjectValues(CallRoute::class)); },
            'chatInfo' => function (ParseNode $n) use ($currentObject) { $currentObject->setChatInfo($n->getObjectValue(ChatInfo::class)); },
            'direction' => function (ParseNode $n) use ($currentObject) { $currentObject->setDirection($n->getEnumValue(CallDirection::class)); },
            'incomingContext' => function (ParseNode $n) use ($currentObject) { $currentObject->setIncomingContext($n->getObjectValue(IncomingContext::class)); },
            'mediaConfig' => function (ParseNode $n) use ($currentObject) { $currentObject->setMediaConfig($n->getObjectValue(MediaConfig::class)); },
            'mediaState' => function (ParseNode $n) use ($currentObject) { $currentObject->setMediaState($n->getObjectValue(CallMediaState::class)); },
            'meetingInfo' => function (ParseNode $n) use ($currentObject) { $currentObject->setMeetingInfo($n->getObjectValue(MeetingInfo::class)); },
            'myParticipantId' => function (ParseNode $n) use ($currentObject) { $currentObject->setMyParticipantId($n->getStringValue()); },
            'operations' => function (ParseNode $n) use ($currentObject) { $currentObject->setOperations($n->getCollectionOfObjectValues(CommsOperation::class)); },
            'participants' => function (ParseNode $n) use ($currentObject) { $currentObject->setParticipants($n->getCollectionOfObjectValues(Participant::class)); },
            'requestedModalities' => function (ParseNode $n) use ($currentObject) { $currentObject->setRequestedModalities($n->getCollectionOfEnumValues(Modality::class)); },
            'resultInfo' => function (ParseNode $n) use ($currentObject) { $currentObject->setResultInfo($n->getObjectValue(ResultInfo::class)); },
            'source' => function (ParseNode $n) use ($currentObject) { $currentObject->setSource($n->getObjectValue(ParticipantInfo::class)); },
            'state' => function (ParseNode $n) use ($currentObject) { $currentObject->setState($n->getEnumValue(CallState::class)); },
            ...
            'toneInfo' => function (ParseNode $n) use ($currentObject) { $currentObject->setToneInfo($n->getObjectValue(ToneInfo::class)); },
            'transcription' => function (ParseNode $n) use ($currentObject) { $currentObject->setTranscription($n->getObjectValue(CallTranscriptionInfo::class)); },
        ]);
    }
