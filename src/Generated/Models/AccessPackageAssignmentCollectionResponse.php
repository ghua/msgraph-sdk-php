...
class AccessPackageAssignmentCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<AccessPackageAssignment>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): AccessPackageAssignmentCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(AccessPackageAssignment::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<AccessPackageAssignment>|null $value Value to set for the value property.
    */
