...
class OutlookCategoryCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<OutlookCategory>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): OutlookCategoryCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(OutlookCategory::class)); },
        ];
    }
