...
class PlannerBucketCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<PlannerBucket>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): PlannerBucketCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(PlannerBucket::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<PlannerBucket>|null $value Value to set for the value property.
    */
