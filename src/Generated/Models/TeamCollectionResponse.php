...
class TeamCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<Team>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): TeamCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(Team::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<Team>|null $value Value to set for the value property.
    */
