...
class ContactCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<Contact>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): ContactCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(Contact::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<Contact>|null $value Value to set for the value property.
    */
