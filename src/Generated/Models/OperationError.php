...
class OperationError implements AdditionalDataHolder, Parsable 
{
    /** @var array<string, mixed> $AdditionalData Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private array $additionalData;
    
    /** @var string|null $code Operation error code. */
    private ?string $code = null;
    
    /** @var string|null $message Operation error message. */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): OperationError {
