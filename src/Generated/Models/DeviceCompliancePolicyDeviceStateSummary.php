...
class DeviceCompliancePolicyDeviceStateSummary extends Entity 
{
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): DeviceCompliancePolicyDeviceStateSummary {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'configManagerCount' => function (ParseNode $n) use ($currentObject) { $currentObject->setConfigManagerCount($n->getIntegerValue()); },
            ...
            'inGracePeriodCount' => function (ParseNode $n) use ($currentObject) { $currentObject->setInGracePeriodCount($n->getIntegerValue()); },
