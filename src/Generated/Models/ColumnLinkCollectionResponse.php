...
class ColumnLinkCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<ColumnLink>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): ColumnLinkCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(ColumnLink::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<ColumnLink>|null $value Value to set for the value property.
    */
