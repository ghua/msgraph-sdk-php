...
class IdentityCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<Identity>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): IdentityCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(Identity::class)); },
        ];
    }
