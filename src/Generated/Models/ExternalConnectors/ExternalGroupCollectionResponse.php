...
class ExternalGroupCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<ExternalGroup>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): ExternalGroupCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(ExternalGroup::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<ExternalGroup>|null $value Value to set for the value property.
    */
