...
class ConnectionOperationCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<ConnectionOperation>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): ConnectionOperationCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(ConnectionOperation::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<ConnectionOperation>|null $value Value to set for the value property.
    */
