...
class ExternalItemCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<ExternalItem>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): ExternalItemCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(ExternalItem::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<ExternalItem>|null $value Value to set for the value property.
    */
