...
class ExternalConnectionCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<ExternalConnection>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): ExternalConnectionCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(ExternalConnection::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<ExternalConnection>|null $value Value to set for the value property.
    */
