...
class BookingCustomQuestionCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<BookingCustomQuestion>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): BookingCustomQuestionCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(BookingCustomQuestion::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<BookingCustomQuestion>|null $value Value to set for the value property.
    */
