...
class ConversationThreadCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<ConversationThread>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): ConversationThreadCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(ConversationThread::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<ConversationThread>|null $value Value to set for the value property.
    */
