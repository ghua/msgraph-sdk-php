...
class MobileThreatDefenseConnectorCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<MobileThreatDefenseConnector>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): MobileThreatDefenseConnectorCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(MobileThreatDefenseConnector::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<MobileThreatDefenseConnector>|null $value Value to set for the value property.
    */
