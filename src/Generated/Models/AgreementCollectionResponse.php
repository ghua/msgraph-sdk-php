...
class AgreementCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<Agreement>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): AgreementCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(Agreement::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<Agreement>|null $value Value to set for the value property.
    */
