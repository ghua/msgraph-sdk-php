...
class RiskyUserHistoryItemCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<RiskyUserHistoryItem>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): RiskyUserHistoryItemCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(RiskyUserHistoryItem::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<RiskyUserHistoryItem>|null $value Value to set for the value property.
    */
