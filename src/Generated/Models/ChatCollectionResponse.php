...
class ChatCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<Chat>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): ChatCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(Chat::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<Chat>|null $value Value to set for the value property.
    */
