    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            'allowedDataStorageLocations' => function (ParseNode $n) use ($currentObject) { $currentObject->setAllowedDataStorageLocations($n->getCollectionOfEnumValues(ManagedAppDataStorageLocation::class)); },
            'allowedInboundDataTransferSources' => function (ParseNode $n) use ($currentObject) { $currentObject->setAllowedInboundDataTransferSources($n->getEnumValue(ManagedAppDataTransferLevel::class)); },
            'allowedOutboundClipboardSharingLevel' => function (ParseNode $n) use ($currentObject) { $currentObject->setAllowedOutboundClipboardSharingLevel($n->getEnumValue(ManagedAppClipboardSharingLevel::class)); },
            'allowedOutboundDataTransferDestinations' => function (ParseNode $n) use ($currentObject) { $currentObject->setAllowedOutboundDataTransferDestinations($n->getEnumValue(ManagedAppDataTransferLevel::class)); },
            'contactSyncBlocked' => function (ParseNode $n) use ($currentObject) { $currentObject->setContactSyncBlocked($n->getBooleanValue()); },
            'dataBackupBlocked' => function (ParseNode $n) use ($currentObject) { $currentObject->setDataBackupBlocked($n->getBooleanValue()); },
            'deviceComplianceRequired' => function (ParseNode $n) use ($currentObject) { $currentObject->setDeviceComplianceRequired($n->getBooleanValue()); },
            'disableAppPinIfDevicePinIsSet' => function (ParseNode $n) use ($currentObject) { $currentObject->setDisableAppPinIfDevicePinIsSet($n->getBooleanValue()); },
            'fingerprintBlocked' => function (ParseNode $n) use ($currentObject) { $currentObject->setFingerprintBlocked($n->getBooleanValue()); },
            'managedBrowser' => function (ParseNode $n) use ($currentObject) { $currentObject->setManagedBrowser($n->getEnumValue(ManagedBrowserType::class)); },
            'managedBrowserToOpenLinksRequired' => function (ParseNode $n) use ($currentObject) { $currentObject->setManagedBrowserToOpenLinksRequired($n->getBooleanValue()); },
            'maximumPinRetries' => function (ParseNode $n) use ($currentObject) { $currentObject->setMaximumPinRetries($n->getIntegerValue()); },
            'minimumPinLength' => function (ParseNode $n) use ($currentObject) { $currentObject->setMinimumPinLength($n->getIntegerValue()); },
            'minimumRequiredAppVersion' => function (ParseNode $n) use ($currentObject) { $currentObject->setMinimumRequiredAppVersion($n->getStringValue()); },
            'minimumRequiredOsVersion' => function (ParseNode $n) use ($currentObject) { $currentObject->setMinimumRequiredOsVersion($n->getStringValue()); },
            'minimumWarningAppVersion' => function (ParseNode $n) use ($currentObject) { $currentObject->setMinimumWarningAppVersion($n->getStringValue()); },
            'minimumWarningOsVersion' => function (ParseNode $n) use ($currentObject) { $currentObject->setMinimumWarningOsVersion($n->getStringValue()); },
            'organizationalCredentialsRequired' => function (ParseNode $n) use ($currentObject) { $currentObject->setOrganizationalCredentialsRequired($n->getBooleanValue()); },
            'periodBeforePinReset' => function (ParseNode $n) use ($currentObject) { $currentObject->setPeriodBeforePinReset($n->getDateIntervalValue()); },
            'periodOfflineBeforeAccessCheck' => function (ParseNode $n) use ($currentObject) { $currentObject->setPeriodOfflineBeforeAccessCheck($n->getDateIntervalValue()); },
            'periodOfflineBeforeWipeIsEnforced' => function (ParseNode $n) use ($currentObject) { $currentObject->setPeriodOfflineBeforeWipeIsEnforced($n->getDateIntervalValue()); },
            'periodOnlineBeforeAccessCheck' => function (ParseNode $n) use ($currentObject) { $currentObject->setPeriodOnlineBeforeAccessCheck($n->getDateIntervalValue()); },
            'pinCharacterSet' => function (ParseNode $n) use ($currentObject) { $currentObject->setPinCharacterSet($n->getEnumValue(ManagedAppPinCharacterSet::class)); },
            'pinRequired' => function (ParseNode $n) use ($currentObject) { $currentObject->setPinRequired($n->getBooleanValue()); },
            'printBlocked' => function (ParseNode $n) use ($currentObject) { $currentObject->setPrintBlocked($n->getBooleanValue()); },
            'saveAsBlocked' => function (ParseNode $n) use ($currentObject) { $currentObject->setSaveAsBlocked($n->getBooleanValue()); },
            'simplePinBlocked' => function (ParseNode $n) use ($currentObject) { $currentObject->setSimplePinBlocked($n->getBooleanValue()); },
        ]);
    }
