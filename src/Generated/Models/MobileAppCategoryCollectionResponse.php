...
class MobileAppCategoryCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<MobileAppCategory>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): MobileAppCategoryCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(MobileAppCategory::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<MobileAppCategory>|null $value Value to set for the value property.
    */
