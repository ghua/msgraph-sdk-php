...
class ScopedRoleMembershipCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<ScopedRoleMembership>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): ScopedRoleMembershipCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(ScopedRoleMembership::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<ScopedRoleMembership>|null $value Value to set for the value property.
    */
