...
class PrintOperationCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<PrintOperation>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): PrintOperationCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(PrintOperation::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<PrintOperation>|null $value Value to set for the value property.
    */
