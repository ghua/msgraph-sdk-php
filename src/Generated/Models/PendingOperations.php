...
class PendingOperations implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return PendingContentUpdate|null
    */
    public function getPendingContentUpdate(): ?PendingContentUpdate {
    ...
    */
    public function serialize(SerializationWriter $writer): void {
        $writer->writeObjectValue('pendingContentUpdate', $this->pendingContentUpdate);
    ...
    */
     ...
     *  @param PendingContentUpdate|null $value Value to set for the pendingContentUpdate property.
    */
    public function setPendingContentUpdate(?PendingContentUpdate $value ): void {
