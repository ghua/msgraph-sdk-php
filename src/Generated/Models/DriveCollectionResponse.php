...
class DriveCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<Drive>|null $value The value property */
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(Drive::class)); },
        ];
    }
