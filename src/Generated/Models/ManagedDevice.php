    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            'activationLockBypassCode' => function (ParseNode $n) use ($currentObject) { $currentObject->setActivationLockBypassCode($n->getStringValue()); },
            'androidSecurityPatchLevel' => function (ParseNode $n) use ($currentObject) { $currentObject->setAndroidSecurityPatchLevel($n->getStringValue()); },
            'azureADDeviceId' => function (ParseNode $n) use ($currentObject) { $currentObject->setAzureADDeviceId($n->getStringValue()); },
            'azureADRegistered' => function (ParseNode $n) use ($currentObject) { $currentObject->setAzureADRegistered($n->getBooleanValue()); },
            ...
            'complianceState' => function (ParseNode $n) use ($currentObject) { $currentObject->setComplianceState($n->getEnumValue(ComplianceState::class)); },
            'configurationManagerClientEnabledFeatures' => function (ParseNode $n) use ($currentObject) { $currentObject->setConfigurationManagerClientEnabledFeatures($n->getObjectValue(ConfigurationManagerClientEnabledFeatures::class)); },
            'deviceActionResults' => function (ParseNode $n) use ($currentObject) { $currentObject->setDeviceActionResults($n->getCollectionOfObjectValues(DeviceActionResult::class)); },
            'deviceCategory' => function (ParseNode $n) use ($currentObject) { $currentObject->setDeviceCategory($n->getObjectValue(DeviceCategory::class)); },
            'deviceCategoryDisplayName' => function (ParseNode $n) use ($currentObject) { $currentObject->setDeviceCategoryDisplayName($n->getStringValue()); },
            'deviceCompliancePolicyStates' => function (ParseNode $n) use ($currentObject) { $currentObject->setDeviceCompliancePolicyStates($n->getCollectionOfObjectValues(DeviceCompliancePolicyState::class)); },
            'deviceConfigurationStates' => function (ParseNode $n) use ($currentObject) { $currentObject->setDeviceConfigurationStates($n->getCollectionOfObjectValues(DeviceConfigurationState::class)); },
            'deviceEnrollmentType' => function (ParseNode $n) use ($currentObject) { $currentObject->setDeviceEnrollmentType($n->getEnumValue(DeviceEnrollmentType::class)); },
            'deviceHealthAttestationState' => function (ParseNode $n) use ($currentObject) { $currentObject->setDeviceHealthAttestationState($n->getObjectValue(DeviceHealthAttestationState::class)); },
            'deviceName' => function (ParseNode $n) use ($currentObject) { $currentObject->setDeviceName($n->getStringValue()); },
            'deviceRegistrationState' => function (ParseNode $n) use ($currentObject) { $currentObject->setDeviceRegistrationState($n->getEnumValue(DeviceRegistrationState::class)); },
            'easActivated' => function (ParseNode $n) use ($currentObject) { $currentObject->setEasActivated($n->getBooleanValue()); },
            'easActivationDateTime' => function (ParseNode $n) use ($currentObject) { $currentObject->setEasActivationDateTime($n->getDateTimeValue()); },
            'easDeviceId' => function (ParseNode $n) use ($currentObject) { $currentObject->setEasDeviceId($n->getStringValue()); },
            'emailAddress' => function (ParseNode $n) use ($currentObject) { $currentObject->setEmailAddress($n->getStringValue()); },
            'enrolledDateTime' => function (ParseNode $n) use ($currentObject) { $currentObject->setEnrolledDateTime($n->getDateTimeValue()); },
            'ethernetMacAddress' => function (ParseNode $n) use ($currentObject) { $currentObject->setEthernetMacAddress($n->getStringValue()); },
            'exchangeAccessState' => function (ParseNode $n) use ($currentObject) { $currentObject->setExchangeAccessState($n->getEnumValue(DeviceManagementExchangeAccessState::class)); },
            'exchangeAccessStateReason' => function (ParseNode $n) use ($currentObject) { $currentObject->setExchangeAccessStateReason($n->getEnumValue(DeviceManagementExchangeAccessStateReason::class)); },
            'exchangeLastSuccessfulSyncDateTime' => function (ParseNode $n) use ($currentObject) { $currentObject->setExchangeLastSuccessfulSyncDateTime($n->getDateTimeValue()); },
            'freeStorageSpaceInBytes' => function (ParseNode $n) use ($currentObject) { $currentObject->setFreeStorageSpaceInBytes($n->getIntegerValue()); },
            'iccid' => function (ParseNode $n) use ($currentObject) { $currentObject->setIccid($n->getStringValue()); },
            'imei' => function (ParseNode $n) use ($currentObject) { $currentObject->setImei($n->getStringValue()); },
            'isEncrypted' => function (ParseNode $n) use ($currentObject) { $currentObject->setIsEncrypted($n->getBooleanValue()); },
            'isSupervised' => function (ParseNode $n) use ($currentObject) { $currentObject->setIsSupervised($n->getBooleanValue()); },
            'jailBroken' => function (ParseNode $n) use ($currentObject) { $currentObject->setJailBroken($n->getStringValue()); },
            'lastSyncDateTime' => function (ParseNode $n) use ($currentObject) { $currentObject->setLastSyncDateTime($n->getDateTimeValue()); },
            'managedDeviceName' => function (ParseNode $n) use ($currentObject) { $currentObject->setManagedDeviceName($n->getStringValue()); },
            'managedDeviceOwnerType' => function (ParseNode $n) use ($currentObject) { $currentObject->setManagedDeviceOwnerType($n->getEnumValue(ManagedDeviceOwnerType::class)); },
            'managementAgent' => function (ParseNode $n) use ($currentObject) { $currentObject->setManagementAgent($n->getEnumValue(ManagementAgentType::class)); },
            'manufacturer' => function (ParseNode $n) use ($currentObject) { $currentObject->setManufacturer($n->getStringValue()); },
            'meid' => function (ParseNode $n) use ($currentObject) { $currentObject->setMeid($n->getStringValue()); },
            ...
            'partnerReportedThreatState' => function (ParseNode $n) use ($currentObject) { $currentObject->setPartnerReportedThreatState($n->getEnumValue(ManagedDevicePartnerReportedHealthState::class)); },
            'phoneNumber' => function (ParseNode $n) use ($currentObject) { $currentObject->setPhoneNumber($n->getStringValue()); },
            'physicalMemoryInBytes' => function (ParseNode $n) use ($currentObject) { $currentObject->setPhysicalMemoryInBytes($n->getIntegerValue()); },
            'remoteAssistanceSessionErrorDetails' => function (ParseNode $n) use ($currentObject) { $currentObject->setRemoteAssistanceSessionErrorDetails($n->getStringValue()); },
            'remoteAssistanceSessionUrl' => function (ParseNode $n) use ($currentObject) { $currentObject->setRemoteAssistanceSessionUrl($n->getStringValue()); },
            'serialNumber' => function (ParseNode $n) use ($currentObject) { $currentObject->setSerialNumber($n->getStringValue()); },
            'subscriberCarrier' => function (ParseNode $n) use ($currentObject) { $currentObject->setSubscriberCarrier($n->getStringValue()); },
            'totalStorageSpaceInBytes' => function (ParseNode $n) use ($currentObject) { $currentObject->setTotalStorageSpaceInBytes($n->getIntegerValue()); },
            'udid' => function (ParseNode $n) use ($currentObject) { $currentObject->setUdid($n->getStringValue()); },
            ...
            'wiFiMacAddress' => function (ParseNode $n) use ($currentObject) { $currentObject->setWiFiMacAddress($n->getStringValue()); },
        ]);
    }
