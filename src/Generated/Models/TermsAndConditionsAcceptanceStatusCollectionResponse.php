...
class TermsAndConditionsAcceptanceStatusCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<TermsAndConditionsAcceptanceStatus>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): TermsAndConditionsAcceptanceStatusCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(TermsAndConditionsAcceptanceStatus::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<TermsAndConditionsAcceptanceStatus>|null $value Value to set for the value property.
    */
