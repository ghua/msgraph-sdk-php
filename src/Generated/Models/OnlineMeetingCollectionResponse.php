...
class OnlineMeetingCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<OnlineMeeting>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): OnlineMeetingCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(OnlineMeeting::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<OnlineMeeting>|null $value Value to set for the value property.
    */
