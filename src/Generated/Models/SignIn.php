    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'appliedConditionalAccessPolicies' => function (ParseNode $n) use ($currentObject) { $currentObject->setAppliedConditionalAccessPolicies($n->getCollectionOfObjectValues(AppliedConditionalAccessPolicy::class)); },
            'clientAppUsed' => function (ParseNode $n) use ($currentObject) { $currentObject->setClientAppUsed($n->getStringValue()); },
            'conditionalAccessStatus' => function (ParseNode $n) use ($currentObject) { $currentObject->setConditionalAccessStatus($n->getEnumValue(ConditionalAccessStatus::class)); },
            ...
            'deviceDetail' => function (ParseNode $n) use ($currentObject) { $currentObject->setDeviceDetail($n->getObjectValue(DeviceDetail::class)); },
            'ipAddress' => function (ParseNode $n) use ($currentObject) { $currentObject->setIpAddress($n->getStringValue()); },
            'isInteractive' => function (ParseNode $n) use ($currentObject) { $currentObject->setIsInteractive($n->getBooleanValue()); },
            'location' => function (ParseNode $n) use ($currentObject) { $currentObject->setLocation($n->getObjectValue(SignInLocation::class)); },
            ...
            'riskEventTypes' => function (ParseNode $n) use ($currentObject) { $currentObject->setRiskEventTypes($n->getCollectionOfEnumValues(RiskEventType::class)); },
            'riskEventTypes_v2' => function (ParseNode $n) use ($currentObject) { $currentObject->setRiskEventTypes_v2($n->getCollectionOfPrimitiveValues()); },
            'riskLevelAggregated' => function (ParseNode $n) use ($currentObject) { $currentObject->setRiskLevelAggregated($n->getEnumValue(RiskLevel::class)); },
            'riskLevelDuringSignIn' => function (ParseNode $n) use ($currentObject) { $currentObject->setRiskLevelDuringSignIn($n->getEnumValue(RiskLevel::class)); },
            'riskState' => function (ParseNode $n) use ($currentObject) { $currentObject->setRiskState($n->getEnumValue(RiskState::class)); },
            'status' => function (ParseNode $n) use ($currentObject) { $currentObject->setStatus($n->getObjectValue(SignInStatus::class)); },
