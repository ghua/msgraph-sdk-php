...
class SignInCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<SignIn>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): SignInCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(SignIn::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<SignIn>|null $value Value to set for the value property.
    */
