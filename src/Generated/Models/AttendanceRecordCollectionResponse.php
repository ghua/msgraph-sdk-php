...
class AttendanceRecordCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<AttendanceRecord>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): AttendanceRecordCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(AttendanceRecord::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<AttendanceRecord>|null $value Value to set for the value property.
    */
