...
class UnifiedRoleAssignmentScheduleRequestCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<UnifiedRoleAssignmentScheduleRequest>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): UnifiedRoleAssignmentScheduleRequestCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(UnifiedRoleAssignmentScheduleRequest::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<UnifiedRoleAssignmentScheduleRequest>|null $value Value to set for the value property.
    */
