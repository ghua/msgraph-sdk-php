...
class PostCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<Post>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): PostCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(Post::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<Post>|null $value Value to set for the value property.
    */
