...
class DeviceComplianceScheduledActionForRuleCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<DeviceComplianceScheduledActionForRule>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): DeviceComplianceScheduledActionForRuleCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(DeviceComplianceScheduledActionForRule::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<DeviceComplianceScheduledActionForRule>|null $value Value to set for the value property.
    */
