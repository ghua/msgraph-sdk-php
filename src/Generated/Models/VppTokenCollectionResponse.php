...
class VppTokenCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<VppToken>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): VppTokenCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(VppToken::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<VppToken>|null $value Value to set for the value property.
    */
