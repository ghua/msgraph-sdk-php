...
class DomainCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<Domain>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): DomainCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(Domain::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<Domain>|null $value Value to set for the value property.
    */
