...
class AgreementAcceptanceCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<AgreementAcceptance>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): AgreementAcceptanceCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(AgreementAcceptance::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<AgreementAcceptance>|null $value Value to set for the value property.
    */
