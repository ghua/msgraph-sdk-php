...
class SwapShiftsChangeRequestCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<SwapShiftsChangeRequest>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): SwapShiftsChangeRequestCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(SwapShiftsChangeRequest::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<SwapShiftsChangeRequest>|null $value Value to set for the value property.
    */
