    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'branding' => function (ParseNode $n) use ($currentObject) { $currentObject->setBranding($n->getObjectValue(OrganizationalBranding::class)); },
            'businessPhones' => function (ParseNode $n) use ($currentObject) { $currentObject->setBusinessPhones($n->getCollectionOfPrimitiveValues()); },
            'certificateBasedAuthConfiguration' => function (ParseNode $n) use ($currentObject) { $currentObject->setCertificateBasedAuthConfiguration($n->getCollectionOfObjectValues(CertificateBasedAuthConfiguration::class)); },
            ...
            'countryLetterCode' => function (ParseNode $n) use ($currentObject) { $currentObject->setCountryLetterCode($n->getStringValue()); },
            ...
            'marketingNotificationEmails' => function (ParseNode $n) use ($currentObject) { $currentObject->setMarketingNotificationEmails($n->getCollectionOfPrimitiveValues()); },
            'mobileDeviceManagementAuthority' => function (ParseNode $n) use ($currentObject) { $currentObject->setMobileDeviceManagementAuthority($n->getEnumValue(MdmAuthority::class)); },
            ...
            'privacyProfile' => function (ParseNode $n) use ($currentObject) { $currentObject->setPrivacyProfile($n->getObjectValue(PrivacyProfile::class)); },
            ...
            'securityComplianceNotificationMails' => function (ParseNode $n) use ($currentObject) { $currentObject->setSecurityComplianceNotificationMails($n->getCollectionOfPrimitiveValues()); },
            'securityComplianceNotificationPhones' => function (ParseNode $n) use ($currentObject) { $currentObject->setSecurityComplianceNotificationPhones($n->getCollectionOfPrimitiveValues()); },
            ...
            'technicalNotificationMails' => function (ParseNode $n) use ($currentObject) { $currentObject->setTechnicalNotificationMails($n->getCollectionOfPrimitiveValues()); },
            'tenantType' => function (ParseNode $n) use ($currentObject) { $currentObject->setTenantType($n->getStringValue()); },
            'verifiedDomains' => function (ParseNode $n) use ($currentObject) { $currentObject->setVerifiedDomains($n->getCollectionOfObjectValues(VerifiedDomain::class)); },
        ]);
    }
