...
class MobileAppAssignmentCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<MobileAppAssignment>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): MobileAppAssignmentCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(MobileAppAssignment::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<MobileAppAssignment>|null $value Value to set for the value property.
    */
