    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'addIns' => function (ParseNode $n) use ($currentObject) { $currentObject->setAddIns($n->getCollectionOfObjectValues(AddIn::class)); },
            'alternativeNames' => function (ParseNode $n) use ($currentObject) { $currentObject->setAlternativeNames($n->getCollectionOfPrimitiveValues()); },
            'appDescription' => function (ParseNode $n) use ($currentObject) { $currentObject->setAppDescription($n->getStringValue()); },
            ...
            'applicationTemplateId' => function (ParseNode $n) use ($currentObject) { $currentObject->setApplicationTemplateId($n->getStringValue()); },
            'appOwnerOrganizationId' => function (ParseNode $n) use ($currentObject) { $currentObject->setAppOwnerOrganizationId($n->getStringValue()); },
            'appRoleAssignedTo' => function (ParseNode $n) use ($currentObject) { $currentObject->setAppRoleAssignedTo($n->getCollectionOfObjectValues(AppRoleAssignment::class)); },
            'appRoleAssignmentRequired' => function (ParseNode $n) use ($currentObject) { $currentObject->setAppRoleAssignmentRequired($n->getBooleanValue()); },
            ...
            'appRoles' => function (ParseNode $n) use ($currentObject) { $currentObject->setAppRoles($n->getCollectionOfObjectValues(AppRole::class)); },
            ...
            'delegatedPermissionClassifications' => function (ParseNode $n) use ($currentObject) { $currentObject->setDelegatedPermissionClassifications($n->getCollectionOfObjectValues(DelegatedPermissionClassification::class)); },
            'description' => function (ParseNode $n) use ($currentObject) { $currentObject->setDescription($n->getStringValue()); },
            'disabledByMicrosoftStatus' => function (ParseNode $n) use ($currentObject) { $currentObject->setDisabledByMicrosoftStatus($n->getStringValue()); },
            'displayName' => function (ParseNode $n) use ($currentObject) { $currentObject->setDisplayName($n->getStringValue()); },
            'endpoints' => function (ParseNode $n) use ($currentObject) { $currentObject->setEndpoints($n->getCollectionOfObjectValues(Endpoint::class)); },
            'homepage' => function (ParseNode $n) use ($currentObject) { $currentObject->setHomepage($n->getStringValue()); },
            ...
            'info' => function (ParseNode $n) use ($currentObject) { $currentObject->setInfo($n->getObjectValue(InformationalUrl::class)); },
            'keyCredentials' => function (ParseNode $n) use ($currentObject) { $currentObject->setKeyCredentials($n->getCollectionOfObjectValues(KeyCredential::class)); },
            'loginUrl' => function (ParseNode $n) use ($currentObject) { $currentObject->setLoginUrl($n->getStringValue()); },
            ...
            'notificationEmailAddresses' => function (ParseNode $n) use ($currentObject) { $currentObject->setNotificationEmailAddresses($n->getCollectionOfPrimitiveValues()); },
            ...
            'passwordCredentials' => function (ParseNode $n) use ($currentObject) { $currentObject->setPasswordCredentials($n->getCollectionOfObjectValues(PasswordCredential::class)); },
            'preferredSingleSignOnMode' => function (ParseNode $n) use ($currentObject) { $currentObject->setPreferredSingleSignOnMode($n->getStringValue()); },
            'preferredTokenSigningKeyThumbprint' => function (ParseNode $n) use ($currentObject) { $currentObject->setPreferredTokenSigningKeyThumbprint($n->getStringValue()); },
            'replyUrls' => function (ParseNode $n) use ($currentObject) { $currentObject->setReplyUrls($n->getCollectionOfPrimitiveValues()); },
            'resourceSpecificApplicationPermissions' => function (ParseNode $n) use ($currentObject) { $currentObject->setResourceSpecificApplicationPermissions($n->getCollectionOfObjectValues(ResourceSpecificPermission::class)); },
            'samlSingleSignOnSettings' => function (ParseNode $n) use ($currentObject) { $currentObject->setSamlSingleSignOnSettings($n->getObjectValue(SamlSingleSignOnSettings::class)); },
            'servicePrincipalNames' => function (ParseNode $n) use ($currentObject) { $currentObject->setServicePrincipalNames($n->getCollectionOfPrimitiveValues()); },
            'servicePrincipalType' => function (ParseNode $n) use ($currentObject) { $currentObject->setServicePrincipalType($n->getStringValue()); },
            'signInAudience' => function (ParseNode $n) use ($currentObject) { $currentObject->setSignInAudience($n->getStringValue()); },
            'tags' => function (ParseNode $n) use ($currentObject) { $currentObject->setTags($n->getCollectionOfPrimitiveValues()); },
            'tokenEncryptionKeyId' => function (ParseNode $n) use ($currentObject) { $currentObject->setTokenEncryptionKeyId($n->getStringValue()); },
