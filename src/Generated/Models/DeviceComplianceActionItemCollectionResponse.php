...
class DeviceComplianceActionItemCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<DeviceComplianceActionItem>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): DeviceComplianceActionItemCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(DeviceComplianceActionItem::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<DeviceComplianceActionItem>|null $value Value to set for the value property.
    */
