...
class IosManagedAppProtectionCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<IosManagedAppProtection>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): IosManagedAppProtectionCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(IosManagedAppProtection::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<IosManagedAppProtection>|null $value Value to set for the value property.
    */
