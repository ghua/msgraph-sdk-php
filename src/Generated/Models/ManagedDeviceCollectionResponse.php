...
class ManagedDeviceCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<ManagedDevice>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): ManagedDeviceCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(ManagedDevice::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<ManagedDevice>|null $value Value to set for the value property.
    */
