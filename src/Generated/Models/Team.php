    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            'channels' => function (ParseNode $n) use ($currentObject) { $currentObject->setChannels($n->getCollectionOfObjectValues(Channel::class)); },
            ...
            'funSettings' => function (ParseNode $n) use ($currentObject) { $currentObject->setFunSettings($n->getObjectValue(TeamFunSettings::class)); },
            'group' => function (ParseNode $n) use ($currentObject) { $currentObject->setGroup($n->getObjectValue(Group::class)); },
            'guestSettings' => function (ParseNode $n) use ($currentObject) { $currentObject->setGuestSettings($n->getObjectValue(TeamGuestSettings::class)); },
            ...
            'internalId' => function (ParseNode $n) use ($currentObject) { $currentObject->setInternalId($n->getStringValue()); },
            ...
            'memberSettings' => function (ParseNode $n) use ($currentObject) { $currentObject->setMemberSettings($n->getObjectValue(TeamMemberSettings::class)); },
            'messagingSettings' => function (ParseNode $n) use ($currentObject) { $currentObject->setMessagingSettings($n->getObjectValue(TeamMessagingSettings::class)); },
            'operations' => function (ParseNode $n) use ($currentObject) { $currentObject->setOperations($n->getCollectionOfObjectValues(TeamsAsyncOperation::class)); },
            'primaryChannel' => function (ParseNode $n) use ($currentObject) { $currentObject->setPrimaryChannel($n->getObjectValue(Channel::class)); },
            'schedule' => function (ParseNode $n) use ($currentObject) { $currentObject->setSchedule($n->getObjectValue(Schedule::class)); },
            'specialization' => function (ParseNode $n) use ($currentObject) { $currentObject->setSpecialization($n->getEnumValue(TeamSpecialization::class)); },
            'template' => function (ParseNode $n) use ($currentObject) { $currentObject->setTemplate($n->getObjectValue(TeamsTemplate::class)); },
            'visibility' => function (ParseNode $n) use ($currentObject) { $currentObject->setVisibility($n->getEnumValue(TeamVisibilityType::class)); },
