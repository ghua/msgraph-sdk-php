...
class DeviceConfigurationDeviceStatusCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<DeviceConfigurationDeviceStatus>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): DeviceConfigurationDeviceStatusCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(DeviceConfigurationDeviceStatus::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<DeviceConfigurationDeviceStatus>|null $value Value to set for the value property.
    */
