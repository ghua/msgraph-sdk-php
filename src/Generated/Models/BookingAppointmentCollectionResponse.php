...
class BookingAppointmentCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<BookingAppointment>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): BookingAppointmentCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(BookingAppointment::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<BookingAppointment>|null $value Value to set for the value property.
    */
