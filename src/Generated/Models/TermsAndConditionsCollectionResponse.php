...
class TermsAndConditionsCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<TermsAndConditions>|null $value The value property */
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(TermsAndConditions::class)); },
        ];
    }
