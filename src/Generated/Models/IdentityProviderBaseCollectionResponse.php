...
class IdentityProviderBaseCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<IdentityProviderBase>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): IdentityProviderBaseCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(IdentityProviderBase::class)); },
        ];
    }
