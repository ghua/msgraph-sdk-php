...
class OnenoteOperationCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<OnenoteOperation>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): OnenoteOperationCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(OnenoteOperation::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<OnenoteOperation>|null $value Value to set for the value property.
    */
