...
class BookingBusinessCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<BookingBusiness>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): BookingBusinessCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(BookingBusiness::class)); },
        ];
    }
