...
class ServiceUpdateMessageCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<ServiceUpdateMessage>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): ServiceUpdateMessageCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(ServiceUpdateMessage::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<ServiceUpdateMessage>|null $value Value to set for the value property.
    */
