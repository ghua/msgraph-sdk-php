...
class DeviceConfigurationUserStatusCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<DeviceConfigurationUserStatus>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): DeviceConfigurationUserStatusCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(DeviceConfigurationUserStatus::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<DeviceConfigurationUserStatus>|null $value Value to set for the value property.
    */
