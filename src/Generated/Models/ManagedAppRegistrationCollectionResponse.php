...
class ManagedAppRegistrationCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<ManagedAppRegistration>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): ManagedAppRegistrationCollectionResponse {
    ...
    */
     ...
     *  @param array<ManagedAppRegistration>|null $value Value to set for the value property.
    */
