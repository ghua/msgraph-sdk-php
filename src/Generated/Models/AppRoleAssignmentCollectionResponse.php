...
class AppRoleAssignmentCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<AppRoleAssignment>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): AppRoleAssignmentCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(AppRoleAssignment::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<AppRoleAssignment>|null $value Value to set for the value property.
    */
