...
class DeviceManagementExportJobCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<DeviceManagementExportJob>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): DeviceManagementExportJobCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(DeviceManagementExportJob::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<DeviceManagementExportJob>|null $value Value to set for the value property.
    */
