...
class OnenoteResourceCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<OnenoteResource>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): OnenoteResourceCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(OnenoteResource::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<OnenoteResource>|null $value Value to set for the value property.
    */
