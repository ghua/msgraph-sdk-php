...
class ListCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<EscapedList>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): ListCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(EscapedList::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<EscapedList>|null $value Value to set for the value property.
    */
