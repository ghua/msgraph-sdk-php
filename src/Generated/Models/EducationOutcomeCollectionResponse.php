...
class EducationOutcomeCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<EducationOutcome>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): EducationOutcomeCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(EducationOutcome::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<EducationOutcome>|null $value Value to set for the value property.
    */
