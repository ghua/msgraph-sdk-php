...
class EducationCategoryCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<EducationCategory>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): EducationCategoryCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(EducationCategory::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<EducationCategory>|null $value Value to set for the value property.
    */
