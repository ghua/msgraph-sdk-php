...
class PrintTaskDefinitionCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<PrintTaskDefinition>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): PrintTaskDefinitionCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(PrintTaskDefinition::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<PrintTaskDefinition>|null $value Value to set for the value property.
    */
