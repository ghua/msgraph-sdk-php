...
class UnifiedRoleManagementPolicyCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<UnifiedRoleManagementPolicy>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): UnifiedRoleManagementPolicyCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(UnifiedRoleManagementPolicy::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<UnifiedRoleManagementPolicy>|null $value Value to set for the value property.
    */
