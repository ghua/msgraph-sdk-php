...
class SegmentCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<Segment>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): SegmentCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(Segment::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<Segment>|null $value Value to set for the value property.
    */
