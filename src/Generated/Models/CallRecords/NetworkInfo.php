...
class NetworkInfo implements AdditionalDataHolder, Parsable 
{
    ...
    */
    public function getFieldDeserializers(): array {
        $currentObject = $this;
        return  [
            'bandwidthLowEventRatio' => function (ParseNode $n) use ($currentObject) { $currentObject->setBandwidthLowEventRatio($n->getFloatValue()); },
            'basicServiceSetIdentifier' => function (ParseNode $n) use ($currentObject) { $currentObject->setBasicServiceSetIdentifier($n->getStringValue()); },
            'connectionType' => function (ParseNode $n) use ($currentObject) { $currentObject->setConnectionType($n->getEnumValue(NetworkConnectionType::class)); },
            'delayEventRatio' => function (ParseNode $n) use ($currentObject) { $currentObject->setDelayEventRatio($n->getFloatValue()); },
            'dnsSuffix' => function (ParseNode $n) use ($currentObject) { $currentObject->setDnsSuffix($n->getStringValue()); },
            'ipAddress' => function (ParseNode $n) use ($currentObject) { $currentObject->setIpAddress($n->getStringValue()); },
            'linkSpeed' => function (ParseNode $n) use ($currentObject) { $currentObject->setLinkSpeed($n->getIntegerValue()); },
            'macAddress' => function (ParseNode $n) use ($currentObject) { $currentObject->setMacAddress($n->getStringValue()); },
            'port' => function (ParseNode $n) use ($currentObject) { $currentObject->setPort($n->getIntegerValue()); },
            'receivedQualityEventRatio' => function (ParseNode $n) use ($currentObject) { $currentObject->setReceivedQualityEventRatio($n->getFloatValue()); },
            'reflexiveIPAddress' => function (ParseNode $n) use ($currentObject) { $currentObject->setReflexiveIPAddress($n->getStringValue()); },
            'relayIPAddress' => function (ParseNode $n) use ($currentObject) { $currentObject->setRelayIPAddress($n->getStringValue()); },
            'relayPort' => function (ParseNode $n) use ($currentObject) { $currentObject->setRelayPort($n->getIntegerValue()); },
            'sentQualityEventRatio' => function (ParseNode $n) use ($currentObject) { $currentObject->setSentQualityEventRatio($n->getFloatValue()); },
            'subnet' => function (ParseNode $n) use ($currentObject) { $currentObject->setSubnet($n->getStringValue()); },
            'wifiBand' => function (ParseNode $n) use ($currentObject) { $currentObject->setWifiBand($n->getEnumValue(WifiBand::class)); },
            'wifiBatteryCharge' => function (ParseNode $n) use ($currentObject) { $currentObject->setWifiBatteryCharge($n->getIntegerValue()); },
            'wifiChannel' => function (ParseNode $n) use ($currentObject) { $currentObject->setWifiChannel($n->getIntegerValue()); },
            'wifiMicrosoftDriver' => function (ParseNode $n) use ($currentObject) { $currentObject->setWifiMicrosoftDriver($n->getStringValue()); },
            'wifiMicrosoftDriverVersion' => function (ParseNode $n) use ($currentObject) { $currentObject->setWifiMicrosoftDriverVersion($n->getStringValue()); },
            'wifiRadioType' => function (ParseNode $n) use ($currentObject) { $currentObject->setWifiRadioType($n->getEnumValue(WifiRadioType::class)); },
            'wifiSignalStrength' => function (ParseNode $n) use ($currentObject) { $currentObject->setWifiSignalStrength($n->getIntegerValue()); },
            'wifiVendorDriver' => function (ParseNode $n) use ($currentObject) { $currentObject->setWifiVendorDriver($n->getStringValue()); },
            'wifiVendorDriverVersion' => function (ParseNode $n) use ($currentObject) { $currentObject->setWifiVendorDriverVersion($n->getStringValue()); },
        ];
    }
