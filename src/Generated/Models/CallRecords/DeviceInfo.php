...
class DeviceInfo implements AdditionalDataHolder, Parsable 
{
    ...
    */
    public function getFieldDeserializers(): array {
        $currentObject = $this;
        return  [
            'captureDeviceDriver' => function (ParseNode $n) use ($currentObject) { $currentObject->setCaptureDeviceDriver($n->getStringValue()); },
            'captureDeviceName' => function (ParseNode $n) use ($currentObject) { $currentObject->setCaptureDeviceName($n->getStringValue()); },
            'captureNotFunctioningEventRatio' => function (ParseNode $n) use ($currentObject) { $currentObject->setCaptureNotFunctioningEventRatio($n->getFloatValue()); },
            'cpuInsufficentEventRatio' => function (ParseNode $n) use ($currentObject) { $currentObject->setCpuInsufficentEventRatio($n->getFloatValue()); },
            'deviceClippingEventRatio' => function (ParseNode $n) use ($currentObject) { $currentObject->setDeviceClippingEventRatio($n->getFloatValue()); },
            'deviceGlitchEventRatio' => function (ParseNode $n) use ($currentObject) { $currentObject->setDeviceGlitchEventRatio($n->getFloatValue()); },
            'howlingEventCount' => function (ParseNode $n) use ($currentObject) { $currentObject->setHowlingEventCount($n->getIntegerValue()); },
            'initialSignalLevelRootMeanSquare' => function (ParseNode $n) use ($currentObject) { $currentObject->setInitialSignalLevelRootMeanSquare($n->getFloatValue()); },
            'lowSpeechLevelEventRatio' => function (ParseNode $n) use ($currentObject) { $currentObject->setLowSpeechLevelEventRatio($n->getFloatValue()); },
            'lowSpeechToNoiseEventRatio' => function (ParseNode $n) use ($currentObject) { $currentObject->setLowSpeechToNoiseEventRatio($n->getFloatValue()); },
            'micGlitchRate' => function (ParseNode $n) use ($currentObject) { $currentObject->setMicGlitchRate($n->getFloatValue()); },
            'receivedNoiseLevel' => function (ParseNode $n) use ($currentObject) { $currentObject->setReceivedNoiseLevel($n->getIntegerValue()); },
            'receivedSignalLevel' => function (ParseNode $n) use ($currentObject) { $currentObject->setReceivedSignalLevel($n->getIntegerValue()); },
            'renderDeviceDriver' => function (ParseNode $n) use ($currentObject) { $currentObject->setRenderDeviceDriver($n->getStringValue()); },
            'renderDeviceName' => function (ParseNode $n) use ($currentObject) { $currentObject->setRenderDeviceName($n->getStringValue()); },
            'renderMuteEventRatio' => function (ParseNode $n) use ($currentObject) { $currentObject->setRenderMuteEventRatio($n->getFloatValue()); },
            'renderNotFunctioningEventRatio' => function (ParseNode $n) use ($currentObject) { $currentObject->setRenderNotFunctioningEventRatio($n->getFloatValue()); },
            'renderZeroVolumeEventRatio' => function (ParseNode $n) use ($currentObject) { $currentObject->setRenderZeroVolumeEventRatio($n->getFloatValue()); },
            'sentNoiseLevel' => function (ParseNode $n) use ($currentObject) { $currentObject->setSentNoiseLevel($n->getIntegerValue()); },
            'sentSignalLevel' => function (ParseNode $n) use ($currentObject) { $currentObject->setSentSignalLevel($n->getIntegerValue()); },
            'speakerGlitchRate' => function (ParseNode $n) use ($currentObject) { $currentObject->setSpeakerGlitchRate($n->getFloatValue()); },
        ];
    }
