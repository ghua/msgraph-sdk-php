...
class MediaStream implements AdditionalDataHolder, Parsable 
{
    ...
    */
    public function getFieldDeserializers(): array {
        $currentObject = $this;
        return  [
            'averageAudioDegradation' => function (ParseNode $n) use ($currentObject) { $currentObject->setAverageAudioDegradation($n->getFloatValue()); },
            'averageAudioNetworkJitter' => function (ParseNode $n) use ($currentObject) { $currentObject->setAverageAudioNetworkJitter($n->getDateIntervalValue()); },
            'averageBandwidthEstimate' => function (ParseNode $n) use ($currentObject) { $currentObject->setAverageBandwidthEstimate($n->getIntegerValue()); },
            'averageJitter' => function (ParseNode $n) use ($currentObject) { $currentObject->setAverageJitter($n->getDateIntervalValue()); },
            'averagePacketLossRate' => function (ParseNode $n) use ($currentObject) { $currentObject->setAveragePacketLossRate($n->getFloatValue()); },
            'averageRatioOfConcealedSamples' => function (ParseNode $n) use ($currentObject) { $currentObject->setAverageRatioOfConcealedSamples($n->getFloatValue()); },
            'averageReceivedFrameRate' => function (ParseNode $n) use ($currentObject) { $currentObject->setAverageReceivedFrameRate($n->getFloatValue()); },
            'averageRoundTripTime' => function (ParseNode $n) use ($currentObject) { $currentObject->setAverageRoundTripTime($n->getDateIntervalValue()); },
            'averageVideoFrameLossPercentage' => function (ParseNode $n) use ($currentObject) { $currentObject->setAverageVideoFrameLossPercentage($n->getFloatValue()); },
            'averageVideoFrameRate' => function (ParseNode $n) use ($currentObject) { $currentObject->setAverageVideoFrameRate($n->getFloatValue()); },
            'averageVideoPacketLossRate' => function (ParseNode $n) use ($currentObject) { $currentObject->setAverageVideoPacketLossRate($n->getFloatValue()); },
            'endDateTime' => function (ParseNode $n) use ($currentObject) { $currentObject->setEndDateTime($n->getDateTimeValue()); },
            'lowFrameRateRatio' => function (ParseNode $n) use ($currentObject) { $currentObject->setLowFrameRateRatio($n->getFloatValue()); },
            'lowVideoProcessingCapabilityRatio' => function (ParseNode $n) use ($currentObject) { $currentObject->setLowVideoProcessingCapabilityRatio($n->getFloatValue()); },
            'maxAudioNetworkJitter' => function (ParseNode $n) use ($currentObject) { $currentObject->setMaxAudioNetworkJitter($n->getDateIntervalValue()); },
            'maxJitter' => function (ParseNode $n) use ($currentObject) { $currentObject->setMaxJitter($n->getDateIntervalValue()); },
            'maxPacketLossRate' => function (ParseNode $n) use ($currentObject) { $currentObject->setMaxPacketLossRate($n->getFloatValue()); },
            'maxRatioOfConcealedSamples' => function (ParseNode $n) use ($currentObject) { $currentObject->setMaxRatioOfConcealedSamples($n->getFloatValue()); },
            'maxRoundTripTime' => function (ParseNode $n) use ($currentObject) { $currentObject->setMaxRoundTripTime($n->getDateIntervalValue()); },
            'packetUtilization' => function (ParseNode $n) use ($currentObject) { $currentObject->setPacketUtilization($n->getIntegerValue()); },
            'postForwardErrorCorrectionPacketLossRate' => function (ParseNode $n) use ($currentObject) { $currentObject->setPostForwardErrorCorrectionPacketLossRate($n->getFloatValue()); },
            'startDateTime' => function (ParseNode $n) use ($currentObject) { $currentObject->setStartDateTime($n->getDateTimeValue()); },
            'streamDirection' => function (ParseNode $n) use ($currentObject) { $currentObject->setStreamDirection($n->getEnumValue(MediaStreamDirection::class)); },
            'streamId' => function (ParseNode $n) use ($currentObject) { $currentObject->setStreamId($n->getStringValue()); },
            'wasMediaBypassed' => function (ParseNode $n) use ($currentObject) { $currentObject->setWasMediaBypassed($n->getBooleanValue()); },
        ];
    }
