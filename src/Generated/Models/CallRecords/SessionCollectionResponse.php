...
class SessionCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<Session>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): SessionCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(Session::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<Session>|null $value Value to set for the value property.
    */
