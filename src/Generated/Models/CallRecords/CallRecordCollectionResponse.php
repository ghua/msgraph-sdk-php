...
class CallRecordCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<CallRecord>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): CallRecordCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(CallRecord::class)); },
        ];
    }
