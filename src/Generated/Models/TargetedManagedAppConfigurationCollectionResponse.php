...
class TargetedManagedAppConfigurationCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<TargetedManagedAppConfiguration>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): TargetedManagedAppConfigurationCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(TargetedManagedAppConfiguration::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<TargetedManagedAppConfiguration>|null $value Value to set for the value property.
    */
