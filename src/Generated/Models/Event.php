    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            'allowNewTimeProposals' => function (ParseNode $n) use ($currentObject) { $currentObject->setAllowNewTimeProposals($n->getBooleanValue()); },
            ...
            'attendees' => function (ParseNode $n) use ($currentObject) { $currentObject->setAttendees($n->getCollectionOfObjectValues(Attendee::class)); },
            ...
            'hideAttendees' => function (ParseNode $n) use ($currentObject) { $currentObject->setHideAttendees($n->getBooleanValue()); },
            'iCalUId' => function (ParseNode $n) use ($currentObject) { $currentObject->setICalUId($n->getStringValue()); },
            'importance' => function (ParseNode $n) use ($currentObject) { $currentObject->setImportance($n->getEnumValue(Importance::class)); },
            'instances' => function (ParseNode $n) use ($currentObject) { $currentObject->setInstances($n->getCollectionOfObjectValues(Event::class)); },
            'isAllDay' => function (ParseNode $n) use ($currentObject) { $currentObject->setIsAllDay($n->getBooleanValue()); },
            'isCancelled' => function (ParseNode $n) use ($currentObject) { $currentObject->setIsCancelled($n->getBooleanValue()); },
            'isDraft' => function (ParseNode $n) use ($currentObject) { $currentObject->setIsDraft($n->getBooleanValue()); },
            'isOnlineMeeting' => function (ParseNode $n) use ($currentObject) { $currentObject->setIsOnlineMeeting($n->getBooleanValue()); },
            'isOrganizer' => function (ParseNode $n) use ($currentObject) { $currentObject->setIsOrganizer($n->getBooleanValue()); },
            'isReminderOn' => function (ParseNode $n) use ($currentObject) { $currentObject->setIsReminderOn($n->getBooleanValue()); },
            'location' => function (ParseNode $n) use ($currentObject) { $currentObject->setLocation($n->getObjectValue(Location::class)); },
            ...
            'onlineMeeting' => function (ParseNode $n) use ($currentObject) { $currentObject->setOnlineMeeting($n->getObjectValue(OnlineMeetingInfo::class)); },
            'onlineMeetingProvider' => function (ParseNode $n) use ($currentObject) { $currentObject->setOnlineMeetingProvider($n->getEnumValue(OnlineMeetingProviderType::class)); },
            'onlineMeetingUrl' => function (ParseNode $n) use ($currentObject) { $currentObject->setOnlineMeetingUrl($n->getStringValue()); },
            'organizer' => function (ParseNode $n) use ($currentObject) { $currentObject->setOrganizer($n->getObjectValue(Recipient::class)); },
            'originalEndTimeZone' => function (ParseNode $n) use ($currentObject) { $currentObject->setOriginalEndTimeZone($n->getStringValue()); },
            'originalStart' => function (ParseNode $n) use ($currentObject) { $currentObject->setOriginalStart($n->getDateTimeValue()); },
            'originalStartTimeZone' => function (ParseNode $n) use ($currentObject) { $currentObject->setOriginalStartTimeZone($n->getStringValue()); },
            'recurrence' => function (ParseNode $n) use ($currentObject) { $currentObject->setRecurrence($n->getObjectValue(PatternedRecurrence::class)); },
            'reminderMinutesBeforeStart' => function (ParseNode $n) use ($currentObject) { $currentObject->setReminderMinutesBeforeStart($n->getIntegerValue()); },
            'responseRequested' => function (ParseNode $n) use ($currentObject) { $currentObject->setResponseRequested($n->getBooleanValue()); },
            'responseStatus' => function (ParseNode $n) use ($currentObject) { $currentObject->setResponseStatus($n->getObjectValue(ResponseStatus::class)); },
            'sensitivity' => function (ParseNode $n) use ($currentObject) { $currentObject->setSensitivity($n->getEnumValue(Sensitivity::class)); },
            'seriesMasterId' => function (ParseNode $n) use ($currentObject) { $currentObject->setSeriesMasterId($n->getStringValue()); },
            'showAs' => function (ParseNode $n) use ($currentObject) { $currentObject->setShowAs($n->getEnumValue(FreeBusyStatus::class)); },
            ...
            'transactionId' => function (ParseNode $n) use ($currentObject) { $currentObject->setTransactionId($n->getStringValue()); },
            'type' => function (ParseNode $n) use ($currentObject) { $currentObject->setType($n->getEnumValue(EventType::class)); },
