...
class ManagedAppStatusCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<ManagedAppStatus>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): ManagedAppStatusCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(ManagedAppStatus::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<ManagedAppStatus>|null $value Value to set for the value property.
    */
