...
class PrintUsageByUserCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<PrintUsageByUser>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): PrintUsageByUserCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(PrintUsageByUser::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<PrintUsageByUser>|null $value Value to set for the value property.
    */
