...
class UserInstallStateSummaryCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<UserInstallStateSummary>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): UserInstallStateSummaryCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(UserInstallStateSummary::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<UserInstallStateSummary>|null $value Value to set for the value property.
    */
