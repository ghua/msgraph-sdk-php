...
class ConversationCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<Conversation>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): ConversationCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(Conversation::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<Conversation>|null $value Value to set for the value property.
    */
