...
class ManagedAppPolicyCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<ManagedAppPolicy>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): ManagedAppPolicyCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(ManagedAppPolicy::class)); },
        ];
    }
