...
class PermissionGrantConditionSetCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<PermissionGrantConditionSet>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): PermissionGrantConditionSetCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(PermissionGrantConditionSet::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<PermissionGrantConditionSet>|null $value Value to set for the value property.
    */
