...
class WindowsAutopilotDeviceIdentityCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<WindowsAutopilotDeviceIdentity>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): WindowsAutopilotDeviceIdentityCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(WindowsAutopilotDeviceIdentity::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<WindowsAutopilotDeviceIdentity>|null $value Value to set for the value property.
    */
