...
class B2xIdentityUserFlowCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<B2xIdentityUserFlow>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): B2xIdentityUserFlowCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(B2xIdentityUserFlow::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<B2xIdentityUserFlow>|null $value Value to set for the value property.
    */
