...
class DeviceManagementExchangeConnectorCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<DeviceManagementExchangeConnector>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): DeviceManagementExchangeConnectorCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(DeviceManagementExchangeConnector::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<DeviceManagementExchangeConnector>|null $value Value to set for the value property.
    */
