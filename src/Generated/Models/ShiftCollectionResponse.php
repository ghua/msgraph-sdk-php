...
class ShiftCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<Shift>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): ShiftCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(Shift::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<Shift>|null $value Value to set for the value property.
    */
