...
class DelegatedPermissionClassificationCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<DelegatedPermissionClassification>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): DelegatedPermissionClassificationCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(DelegatedPermissionClassification::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<DelegatedPermissionClassification>|null $value Value to set for the value property.
    */
