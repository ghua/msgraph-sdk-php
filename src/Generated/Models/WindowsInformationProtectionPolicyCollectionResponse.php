...
class WindowsInformationProtectionPolicyCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<WindowsInformationProtectionPolicy>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): WindowsInformationProtectionPolicyCollectionResponse {
    ...
    */
     ...
     *  @param array<WindowsInformationProtectionPolicy>|null $value Value to set for the value property.
    */
