...
class TodoTaskCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<TodoTask>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): TodoTaskCollectionResponse {
    ...
    */
     ...
     *  @param array<TodoTask>|null $value Value to set for the value property.
    */
