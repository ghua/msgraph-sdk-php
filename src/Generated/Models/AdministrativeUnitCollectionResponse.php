...
class AdministrativeUnitCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<AdministrativeUnit>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): AdministrativeUnitCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(AdministrativeUnit::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<AdministrativeUnit>|null $value Value to set for the value property.
    */
