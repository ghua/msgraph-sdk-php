...
class RiskyUserCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<RiskyUser>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): RiskyUserCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(RiskyUser::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<RiskyUser>|null $value Value to set for the value property.
    */
