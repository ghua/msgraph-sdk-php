...
class TelecomExpenseManagementPartnerCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<TelecomExpenseManagementPartner>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): TelecomExpenseManagementPartnerCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(TelecomExpenseManagementPartner::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<TelecomExpenseManagementPartner>|null $value Value to set for the value property.
    */
