    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'alternativeSecurityIds' => function (ParseNode $n) use ($currentObject) { $currentObject->setAlternativeSecurityIds($n->getCollectionOfObjectValues(AlternativeSecurityId::class)); },
            'approximateLastSignInDateTime' => function (ParseNode $n) use ($currentObject) { $currentObject->setApproximateLastSignInDateTime($n->getDateTimeValue()); },
            'complianceExpirationDateTime' => function (ParseNode $n) use ($currentObject) { $currentObject->setComplianceExpirationDateTime($n->getDateTimeValue()); },
            'deviceId' => function (ParseNode $n) use ($currentObject) { $currentObject->setDeviceId($n->getStringValue()); },
            'deviceMetadata' => function (ParseNode $n) use ($currentObject) { $currentObject->setDeviceMetadata($n->getStringValue()); },
            'deviceVersion' => function (ParseNode $n) use ($currentObject) { $currentObject->setDeviceVersion($n->getIntegerValue()); },
            ...
            'mdmAppId' => function (ParseNode $n) use ($currentObject) { $currentObject->setMdmAppId($n->getStringValue()); },
            ...
            'operatingSystemVersion' => function (ParseNode $n) use ($currentObject) { $currentObject->setOperatingSystemVersion($n->getStringValue()); },
            'physicalIds' => function (ParseNode $n) use ($currentObject) { $currentObject->setPhysicalIds($n->getCollectionOfPrimitiveValues()); },
            'profileType' => function (ParseNode $n) use ($currentObject) { $currentObject->setProfileType($n->getStringValue()); },
            'registeredOwners' => function (ParseNode $n) use ($currentObject) { $currentObject->setRegisteredOwners($n->getCollectionOfObjectValues(DirectoryObject::class)); },
            'registeredUsers' => function (ParseNode $n) use ($currentObject) { $currentObject->setRegisteredUsers($n->getCollectionOfObjectValues(DirectoryObject::class)); },
            'systemLabels' => function (ParseNode $n) use ($currentObject) { $currentObject->setSystemLabels($n->getCollectionOfPrimitiveValues()); },
