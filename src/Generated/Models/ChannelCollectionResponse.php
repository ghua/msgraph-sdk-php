...
class ChannelCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<Channel>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): ChannelCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(Channel::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<Channel>|null $value Value to set for the value property.
    */
