...
class OnenoteSectionCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<OnenoteSection>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): OnenoteSectionCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(OnenoteSection::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<OnenoteSection>|null $value Value to set for the value property.
    */
