...
class FeatureRolloutPolicyCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<FeatureRolloutPolicy>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): FeatureRolloutPolicyCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(FeatureRolloutPolicy::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<FeatureRolloutPolicy>|null $value Value to set for the value property.
    */
