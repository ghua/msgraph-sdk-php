    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            ...
            'api' => function (ParseNode $n) use ($currentObject) { $currentObject->setApi($n->getObjectValue(ApiApplication::class)); },
            ...
            'extensionProperties' => function (ParseNode $n) use ($currentObject) { $currentObject->setExtensionProperties($n->getCollectionOfObjectValues(ExtensionProperty::class)); },
            'groupMembershipClaims' => function (ParseNode $n) use ($currentObject) { $currentObject->setGroupMembershipClaims($n->getStringValue()); },
            ...
            'identifierUris' => function (ParseNode $n) use ($currentObject) { $currentObject->setIdentifierUris($n->getCollectionOfPrimitiveValues()); },
            'info' => function (ParseNode $n) use ($currentObject) { $currentObject->setInfo($n->getObjectValue(InformationalUrl::class)); },
            'isDeviceOnlyAuthSupported' => function (ParseNode $n) use ($currentObject) { $currentObject->setIsDeviceOnlyAuthSupported($n->getBooleanValue()); },
            'isFallbackPublicClient' => function (ParseNode $n) use ($currentObject) { $currentObject->setIsFallbackPublicClient($n->getBooleanValue()); },
            ...
            'logo' => function (ParseNode $n) use ($currentObject) { $currentObject->setLogo($n->getBinaryContent()); },
            'notes' => function (ParseNode $n) use ($currentObject) { $currentObject->setNotes($n->getStringValue()); },
            'oauth2RequirePostResponse' => function (ParseNode $n) use ($currentObject) { $currentObject->setOauth2RequirePostResponse($n->getBooleanValue()); },
            'optionalClaims' => function (ParseNode $n) use ($currentObject) { $currentObject->setOptionalClaims($n->getObjectValue(OptionalClaims::class)); },
            ...
            'parentalControlSettings' => function (ParseNode $n) use ($currentObject) { $currentObject->setParentalControlSettings($n->getObjectValue(ParentalControlSettings::class)); },
            ...
            'publicClient' => function (ParseNode $n) use ($currentObject) { $currentObject->setPublicClient($n->getObjectValue(PublicClientApplication::class)); },
            'publisherDomain' => function (ParseNode $n) use ($currentObject) { $currentObject->setPublisherDomain($n->getStringValue()); },
            'requiredResourceAccess' => function (ParseNode $n) use ($currentObject) { $currentObject->setRequiredResourceAccess($n->getCollectionOfObjectValues(RequiredResourceAccess::class)); },
            'signInAudience' => function (ParseNode $n) use ($currentObject) { $currentObject->setSignInAudience($n->getStringValue()); },
            'spa' => function (ParseNode $n) use ($currentObject) { $currentObject->setSpa($n->getObjectValue(SpaApplication::class)); },
            ...
            'verifiedPublisher' => function (ParseNode $n) use ($currentObject) { $currentObject->setVerifiedPublisher($n->getObjectValue(VerifiedPublisher::class)); },
            'web' => function (ParseNode $n) use ($currentObject) { $currentObject->setWeb($n->getObjectValue(WebApplication::class)); },
        ]);
    }
