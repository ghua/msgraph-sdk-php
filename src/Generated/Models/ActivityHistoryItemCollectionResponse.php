...
class ActivityHistoryItemCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<ActivityHistoryItem>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): ActivityHistoryItemCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(ActivityHistoryItem::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<ActivityHistoryItem>|null $value Value to set for the value property.
    */
