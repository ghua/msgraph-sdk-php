...
class ThumbnailSetCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<ThumbnailSet>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): ThumbnailSetCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(ThumbnailSet::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<ThumbnailSet>|null $value Value to set for the value property.
    */
