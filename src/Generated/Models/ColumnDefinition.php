    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            'boolean' => function (ParseNode $n) use ($currentObject) { $currentObject->setBoolean($n->getObjectValue(BooleanColumn::class)); },
            'calculated' => function (ParseNode $n) use ($currentObject) { $currentObject->setCalculated($n->getObjectValue(CalculatedColumn::class)); },
            'choice' => function (ParseNode $n) use ($currentObject) { $currentObject->setChoice($n->getObjectValue(ChoiceColumn::class)); },
            'columnGroup' => function (ParseNode $n) use ($currentObject) { $currentObject->setColumnGroup($n->getStringValue()); },
            'contentApprovalStatus' => function (ParseNode $n) use ($currentObject) { $currentObject->setContentApprovalStatus($n->getObjectValue(ContentApprovalStatusColumn::class)); },
            'currency' => function (ParseNode $n) use ($currentObject) { $currentObject->setCurrency($n->getObjectValue(CurrencyColumn::class)); },
            'dateTime' => function (ParseNode $n) use ($currentObject) { $currentObject->setDateTime($n->getObjectValue(DateTimeColumn::class)); },
            'defaultValue' => function (ParseNode $n) use ($currentObject) { $currentObject->setDefaultValue($n->getObjectValue(DefaultColumnValue::class)); },
            'description' => function (ParseNode $n) use ($currentObject) { $currentObject->setDescription($n->getStringValue()); },
            'displayName' => function (ParseNode $n) use ($currentObject) { $currentObject->setDisplayName($n->getStringValue()); },
            'enforceUniqueValues' => function (ParseNode $n) use ($currentObject) { $currentObject->setEnforceUniqueValues($n->getBooleanValue()); },
            'geolocation' => function (ParseNode $n) use ($currentObject) { $currentObject->setGeolocation($n->getObjectValue(GeolocationColumn::class)); },
            'hidden' => function (ParseNode $n) use ($currentObject) { $currentObject->setHidden($n->getBooleanValue()); },
            'hyperlinkOrPicture' => function (ParseNode $n) use ($currentObject) { $currentObject->setHyperlinkOrPicture($n->getObjectValue(HyperlinkOrPictureColumn::class)); },
            'indexed' => function (ParseNode $n) use ($currentObject) { $currentObject->setIndexed($n->getBooleanValue()); },
            'isDeletable' => function (ParseNode $n) use ($currentObject) { $currentObject->setIsDeletable($n->getBooleanValue()); },
            'isReorderable' => function (ParseNode $n) use ($currentObject) { $currentObject->setIsReorderable($n->getBooleanValue()); },
            'isSealed' => function (ParseNode $n) use ($currentObject) { $currentObject->setIsSealed($n->getBooleanValue()); },
            'lookup' => function (ParseNode $n) use ($currentObject) { $currentObject->setLookup($n->getObjectValue(LookupColumn::class)); },
            'name' => function (ParseNode $n) use ($currentObject) { $currentObject->setName($n->getStringValue()); },
            'number' => function (ParseNode $n) use ($currentObject) { $currentObject->setNumber($n->getObjectValue(NumberColumn::class)); },
            'personOrGroup' => function (ParseNode $n) use ($currentObject) { $currentObject->setPersonOrGroup($n->getObjectValue(PersonOrGroupColumn::class)); },
            ...
            'required' => function (ParseNode $n) use ($currentObject) { $currentObject->setRequired($n->getBooleanValue()); },
            'sourceColumn' => function (ParseNode $n) use ($currentObject) { $currentObject->setSourceColumn($n->getObjectValue(ColumnDefinition::class)); },
            'sourceContentType' => function (ParseNode $n) use ($currentObject) { $currentObject->setSourceContentType($n->getObjectValue(ContentTypeInfo::class)); },
            'term' => function (ParseNode $n) use ($currentObject) { $currentObject->setTerm($n->getObjectValue(TermColumn::class)); },
            'text' => function (ParseNode $n) use ($currentObject) { $currentObject->setText($n->getObjectValue(TextColumn::class)); },
            'thumbnail' => function (ParseNode $n) use ($currentObject) { $currentObject->setThumbnail($n->getObjectValue(ThumbnailColumn::class)); },
            'type' => function (ParseNode $n) use ($currentObject) { $currentObject->setType($n->getEnumValue(ColumnTypes::class)); },
            'validation' => function (ParseNode $n) use ($currentObject) { $currentObject->setValidation($n->getObjectValue(ColumnValidation::class)); },
        ]);
    }
