...
class UnifiedRoleDefinitionCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<UnifiedRoleDefinition>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): UnifiedRoleDefinitionCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(UnifiedRoleDefinition::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<UnifiedRoleDefinition>|null $value Value to set for the value property.
    */
