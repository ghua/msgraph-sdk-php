...
class TeamsAppDefinitionCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<TeamsAppDefinition>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): TeamsAppDefinitionCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(TeamsAppDefinition::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<TeamsAppDefinition>|null $value Value to set for the value property.
    */
