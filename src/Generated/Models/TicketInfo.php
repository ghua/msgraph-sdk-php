...
class TicketInfo implements AdditionalDataHolder, Parsable 
{
    ...
    */
    public function getFieldDeserializers(): array {
        $currentObject = $this;
        return  [
            'ticketNumber' => function (ParseNode $n) use ($currentObject) { $currentObject->setTicketNumber($n->getStringValue()); },
            'ticketSystem' => function (ParseNode $n) use ($currentObject) { $currentObject->setTicketSystem($n->getStringValue()); },
        ];
    }
