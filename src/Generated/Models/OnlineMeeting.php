    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            'allowAttendeeToEnableCamera' => function (ParseNode $n) use ($currentObject) { $currentObject->setAllowAttendeeToEnableCamera($n->getBooleanValue()); },
            'allowAttendeeToEnableMic' => function (ParseNode $n) use ($currentObject) { $currentObject->setAllowAttendeeToEnableMic($n->getBooleanValue()); },
            'allowedPresenters' => function (ParseNode $n) use ($currentObject) { $currentObject->setAllowedPresenters($n->getEnumValue(OnlineMeetingPresenters::class)); },
            'allowMeetingChat' => function (ParseNode $n) use ($currentObject) { $currentObject->setAllowMeetingChat($n->getEnumValue(MeetingChatMode::class)); },
            'allowTeamworkReactions' => function (ParseNode $n) use ($currentObject) { $currentObject->setAllowTeamworkReactions($n->getBooleanValue()); },
            'attendanceReports' => function (ParseNode $n) use ($currentObject) { $currentObject->setAttendanceReports($n->getCollectionOfObjectValues(MeetingAttendanceReport::class)); },
            'attendeeReport' => function (ParseNode $n) use ($currentObject) { $currentObject->setAttendeeReport($n->getBinaryContent()); },
            'audioConferencing' => function (ParseNode $n) use ($currentObject) { $currentObject->setAudioConferencing($n->getObjectValue(AudioConferencing::class)); },
            'broadcastSettings' => function (ParseNode $n) use ($currentObject) { $currentObject->setBroadcastSettings($n->getObjectValue(BroadcastMeetingSettings::class)); },
            'chatInfo' => function (ParseNode $n) use ($currentObject) { $currentObject->setChatInfo($n->getObjectValue(ChatInfo::class)); },
            'creationDateTime' => function (ParseNode $n) use ($currentObject) { $currentObject->setCreationDateTime($n->getDateTimeValue()); },
            ...
            'isBroadcast' => function (ParseNode $n) use ($currentObject) { $currentObject->setIsBroadcast($n->getBooleanValue()); },
            'isEntryExitAnnounced' => function (ParseNode $n) use ($currentObject) { $currentObject->setIsEntryExitAnnounced($n->getBooleanValue()); },
            'joinInformation' => function (ParseNode $n) use ($currentObject) { $currentObject->setJoinInformation($n->getObjectValue(ItemBody::class)); },
            'joinWebUrl' => function (ParseNode $n) use ($currentObject) { $currentObject->setJoinWebUrl($n->getStringValue()); },
            'lobbyBypassSettings' => function (ParseNode $n) use ($currentObject) { $currentObject->setLobbyBypassSettings($n->getObjectValue(LobbyBypassSettings::class)); },
            ...
            'recordAutomatically' => function (ParseNode $n) use ($currentObject) { $currentObject->setRecordAutomatically($n->getBooleanValue()); },
            ...
            'videoTeleconferenceId' => function (ParseNode $n) use ($currentObject) { $currentObject->setVideoTeleconferenceId($n->getStringValue()); },
        ]);
    }
