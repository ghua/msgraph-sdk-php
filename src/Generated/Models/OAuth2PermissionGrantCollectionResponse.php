...
class OAuth2PermissionGrantCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<OAuth2PermissionGrant>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): OAuth2PermissionGrantCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(OAuth2PermissionGrant::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<OAuth2PermissionGrant>|null $value Value to set for the value property.
    */
