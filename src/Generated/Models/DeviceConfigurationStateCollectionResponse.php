...
class DeviceConfigurationStateCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<DeviceConfigurationState>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): DeviceConfigurationStateCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(DeviceConfigurationState::class)); },
        ];
    }
