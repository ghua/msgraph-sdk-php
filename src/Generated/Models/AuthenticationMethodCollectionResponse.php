...
class AuthenticationMethodCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<AuthenticationMethod>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): AuthenticationMethodCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(AuthenticationMethod::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<AuthenticationMethod>|null $value Value to set for the value property.
    */
