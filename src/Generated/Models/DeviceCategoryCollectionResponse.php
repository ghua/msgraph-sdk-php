...
class DeviceCategoryCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<DeviceCategory>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): DeviceCategoryCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(DeviceCategory::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<DeviceCategory>|null $value Value to set for the value property.
    */
