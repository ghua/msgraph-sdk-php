...
class EducationSchoolCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<EducationSchool>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): EducationSchoolCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(EducationSchool::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<EducationSchool>|null $value Value to set for the value property.
    */
