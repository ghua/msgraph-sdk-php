...
class CertificateBasedAuthConfigurationCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<CertificateBasedAuthConfiguration>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): CertificateBasedAuthConfigurationCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(CertificateBasedAuthConfiguration::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<CertificateBasedAuthConfiguration>|null $value Value to set for the value property.
    */
