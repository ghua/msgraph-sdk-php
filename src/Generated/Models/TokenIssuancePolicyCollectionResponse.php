...
class TokenIssuancePolicyCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<TokenIssuancePolicy>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): TokenIssuancePolicyCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(TokenIssuancePolicy::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<TokenIssuancePolicy>|null $value Value to set for the value property.
    */
