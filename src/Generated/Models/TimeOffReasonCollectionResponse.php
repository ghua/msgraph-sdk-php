...
class TimeOffReasonCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<TimeOffReason>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): TimeOffReasonCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(TimeOffReason::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<TimeOffReason>|null $value Value to set for the value property.
    */
