...
class BookingServiceCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<BookingService>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): BookingServiceCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(BookingService::class)); },
        ];
    }
