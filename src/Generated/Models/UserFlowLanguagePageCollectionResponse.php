...
class UserFlowLanguagePageCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<UserFlowLanguagePage>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): UserFlowLanguagePageCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(UserFlowLanguagePage::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<UserFlowLanguagePage>|null $value Value to set for the value property.
    */
