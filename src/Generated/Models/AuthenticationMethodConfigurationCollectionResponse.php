...
class AuthenticationMethodConfigurationCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<AuthenticationMethodConfiguration>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): AuthenticationMethodConfigurationCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(AuthenticationMethodConfiguration::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<AuthenticationMethodConfiguration>|null $value Value to set for the value property.
    */
