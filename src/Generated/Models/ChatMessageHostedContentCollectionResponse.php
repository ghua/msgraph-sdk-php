...
class ChatMessageHostedContentCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<ChatMessageHostedContent>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): ChatMessageHostedContentCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(ChatMessageHostedContent::class)); },
        ];
    }
