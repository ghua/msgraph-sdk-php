...
class LinkedResourceCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<LinkedResource>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): LinkedResourceCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(LinkedResource::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<LinkedResource>|null $value Value to set for the value property.
    */
