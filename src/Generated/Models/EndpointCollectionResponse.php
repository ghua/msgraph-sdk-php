...
class EndpointCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<Endpoint>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): EndpointCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(Endpoint::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<Endpoint>|null $value Value to set for the value property.
    */
