...
class TargetedManagedAppPolicyAssignmentCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<TargetedManagedAppPolicyAssignment>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): TargetedManagedAppPolicyAssignmentCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(TargetedManagedAppPolicyAssignment::class)); },
        ];
    }
