...
class AccessReviewHistoryInstanceCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<AccessReviewHistoryInstance>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): AccessReviewHistoryInstanceCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(AccessReviewHistoryInstance::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<AccessReviewHistoryInstance>|null $value Value to set for the value property.
    */
