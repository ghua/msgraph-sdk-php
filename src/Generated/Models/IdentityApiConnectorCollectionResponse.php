...
class IdentityApiConnectorCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<IdentityApiConnector>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): IdentityApiConnectorCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(IdentityApiConnector::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<IdentityApiConnector>|null $value Value to set for the value property.
    */
