...
class UnifiedRoleAssignmentScheduleCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<UnifiedRoleAssignmentSchedule>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): UnifiedRoleAssignmentScheduleCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(UnifiedRoleAssignmentSchedule::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<UnifiedRoleAssignmentSchedule>|null $value Value to set for the value property.
    */
