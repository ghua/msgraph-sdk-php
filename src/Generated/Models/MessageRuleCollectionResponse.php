...
class MessageRuleCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<MessageRule>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): MessageRuleCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(MessageRule::class)); },
        ];
    }
