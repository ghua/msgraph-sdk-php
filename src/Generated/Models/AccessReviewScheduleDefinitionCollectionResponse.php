...
class AccessReviewScheduleDefinitionCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<AccessReviewScheduleDefinition>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): AccessReviewScheduleDefinitionCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(AccessReviewScheduleDefinition::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<AccessReviewScheduleDefinition>|null $value Value to set for the value property.
    */
