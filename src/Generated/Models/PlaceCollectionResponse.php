...
class PlaceCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<Place>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): PlaceCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(Place::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<Place>|null $value Value to set for the value property.
    */
