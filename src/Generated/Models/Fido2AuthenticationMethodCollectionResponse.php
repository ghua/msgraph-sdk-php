...
class Fido2AuthenticationMethodCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<Fido2AuthenticationMethod>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): Fido2AuthenticationMethodCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(Fido2AuthenticationMethod::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<Fido2AuthenticationMethod>|null $value Value to set for the value property.
    */
