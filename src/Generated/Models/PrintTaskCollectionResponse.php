...
class PrintTaskCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<PrintTask>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): PrintTaskCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(PrintTask::class)); },
        ];
    }
