...
class LicenseDetailsCollectionResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /** @var array<LicenseDetails>|null $value The value property */
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): LicenseDetailsCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($currentObject) { $currentObject->setValue($n->getCollectionOfObjectValues(LicenseDetails::class)); },
        ];
    }
    ...
    */
     ...
     *  @param array<LicenseDetails>|null $value Value to set for the value property.
    */
