...
class AssignUserToDeviceRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return AssignUserToDeviceRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): AssignUserToDeviceRequestBody {
