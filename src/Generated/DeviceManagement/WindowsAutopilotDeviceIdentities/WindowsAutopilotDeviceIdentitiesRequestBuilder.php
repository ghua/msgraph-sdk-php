...
class WindowsAutopilotDeviceIdentitiesRequestBuilder 
{
    ...
    */
     ...
     * @return RequestInformation
    */
    public function createPostRequestInformation(WindowsAutopilotDeviceIdentity $body, ?array $headers = null, ?array $options = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = $this->urlTemplate;
        $requestInfo->pathParameters = $this->pathParameters;
    ...
    */
    public function get(?array $queryParameters = null, ?array $headers = null, ?array $options = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            return $this->requestAdapter->sendAsync($requestInfo, WindowsAutopilotDeviceIdentityCollectionResponse::class, $responseHandler);
        } catch(Exception $ex) {
     ...
     * @return Promise
    */
    public function post(WindowsAutopilotDeviceIdentity $body, ?array $headers = null, ?array $options = null, ?ResponseHandler $responseHandler = null): Promise {
        $requestInfo = $this->createPostRequestInformation($body, $headers, $options);
        try {
            return $this->requestAdapter->sendAsync($requestInfo, WindowsAutopilotDeviceIdentity::class, $responseHandler);
        } catch(Exception $ex) {
            return new RejectedPromise($ex);
        }
    }
