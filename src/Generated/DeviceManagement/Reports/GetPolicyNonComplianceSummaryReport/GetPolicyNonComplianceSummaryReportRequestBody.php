...
class GetPolicyNonComplianceSummaryReportRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return GetPolicyNonComplianceSummaryReportRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): GetPolicyNonComplianceSummaryReportRequestBody {
