...
class GetPolicyNonComplianceSummaryReportResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /**
     * Instantiates a new getPolicyNonComplianceSummaryReportResponse and sets the default values.
    */
     ...
     * @return GetPolicyNonComplianceSummaryReportResponse
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): GetPolicyNonComplianceSummaryReportResponse {
