...
class GetDeviceManagementIntentSettingsReportRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return GetDeviceManagementIntentSettingsReportRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): GetDeviceManagementIntentSettingsReportRequestBody {
