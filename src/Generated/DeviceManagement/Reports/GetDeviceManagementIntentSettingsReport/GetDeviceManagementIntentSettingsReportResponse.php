...
class GetDeviceManagementIntentSettingsReportResponse implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return GetDeviceManagementIntentSettingsReportResponse
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): GetDeviceManagementIntentSettingsReportResponse {
        return new GetDeviceManagementIntentSettingsReportResponse();
    }
