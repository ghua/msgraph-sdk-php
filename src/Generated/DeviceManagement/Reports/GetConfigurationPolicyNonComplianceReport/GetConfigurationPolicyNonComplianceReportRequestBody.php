...
class GetConfigurationPolicyNonComplianceReportRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return GetConfigurationPolicyNonComplianceReportRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): GetConfigurationPolicyNonComplianceReportRequestBody {
