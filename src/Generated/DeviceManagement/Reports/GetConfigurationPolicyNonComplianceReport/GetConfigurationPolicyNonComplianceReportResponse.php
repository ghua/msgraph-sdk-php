...
class GetConfigurationPolicyNonComplianceReportResponse implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return GetConfigurationPolicyNonComplianceReportResponse
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): GetConfigurationPolicyNonComplianceReportResponse {
