...
class GetCachedReportResponse implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return GetCachedReportResponse
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): GetCachedReportResponse {
