...
class GetPolicyNonComplianceMetadataResponse implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return GetPolicyNonComplianceMetadataResponse
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): GetPolicyNonComplianceMetadataResponse {
