...
class GetPolicyNonComplianceMetadataRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return GetPolicyNonComplianceMetadataRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): GetPolicyNonComplianceMetadataRequestBody {
