...
class GetComplianceSettingNonComplianceReportRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return GetComplianceSettingNonComplianceReportRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): GetComplianceSettingNonComplianceReportRequestBody {
