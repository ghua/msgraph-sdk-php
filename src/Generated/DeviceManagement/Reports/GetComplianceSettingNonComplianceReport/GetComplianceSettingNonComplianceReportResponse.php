...
class GetComplianceSettingNonComplianceReportResponse implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return GetComplianceSettingNonComplianceReportResponse
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): GetComplianceSettingNonComplianceReportResponse {
