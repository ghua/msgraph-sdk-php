...
class GetSettingNonComplianceReportRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return GetSettingNonComplianceReportRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): GetSettingNonComplianceReportRequestBody {
