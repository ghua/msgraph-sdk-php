...
class GetSettingNonComplianceReportResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /**
     * Instantiates a new getSettingNonComplianceReportResponse and sets the default values.
    */
     ...
     * @return GetSettingNonComplianceReportResponse
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): GetSettingNonComplianceReportResponse {
