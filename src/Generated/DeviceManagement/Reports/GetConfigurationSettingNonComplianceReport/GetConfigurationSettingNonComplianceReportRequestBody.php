...
class GetConfigurationSettingNonComplianceReportRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return GetConfigurationSettingNonComplianceReportRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): GetConfigurationSettingNonComplianceReportRequestBody {
