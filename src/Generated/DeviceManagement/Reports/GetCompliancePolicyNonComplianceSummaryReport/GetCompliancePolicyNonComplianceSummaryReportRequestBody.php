...
class GetCompliancePolicyNonComplianceSummaryReportRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return GetCompliancePolicyNonComplianceSummaryReportRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): GetCompliancePolicyNonComplianceSummaryReportRequestBody {
