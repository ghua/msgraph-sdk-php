...
class GetConfigurationPolicyNonComplianceSummaryReportRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return GetConfigurationPolicyNonComplianceSummaryReportRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): GetConfigurationPolicyNonComplianceSummaryReportRequestBody {
