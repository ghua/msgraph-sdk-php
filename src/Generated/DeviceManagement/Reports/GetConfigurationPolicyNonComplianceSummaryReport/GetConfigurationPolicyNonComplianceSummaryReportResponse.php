...
class GetConfigurationPolicyNonComplianceSummaryReportResponse implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return GetConfigurationPolicyNonComplianceSummaryReportResponse
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): GetConfigurationPolicyNonComplianceSummaryReportResponse {
