...
class GetHistoricalReportResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /**
     * Instantiates a new getHistoricalReportResponse and sets the default values.
    */
     ...
     * @return GetHistoricalReportResponse
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): GetHistoricalReportResponse {
