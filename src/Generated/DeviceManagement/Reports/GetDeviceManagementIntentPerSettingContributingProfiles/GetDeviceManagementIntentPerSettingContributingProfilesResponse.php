...
class GetDeviceManagementIntentPerSettingContributingProfilesResponse implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return GetDeviceManagementIntentPerSettingContributingProfilesResponse
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): GetDeviceManagementIntentPerSettingContributingProfilesResponse {
