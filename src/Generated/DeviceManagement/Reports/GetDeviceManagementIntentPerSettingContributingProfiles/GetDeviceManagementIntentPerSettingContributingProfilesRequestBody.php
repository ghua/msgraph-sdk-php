...
class GetDeviceManagementIntentPerSettingContributingProfilesRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return GetDeviceManagementIntentPerSettingContributingProfilesRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): GetDeviceManagementIntentPerSettingContributingProfilesRequestBody {
