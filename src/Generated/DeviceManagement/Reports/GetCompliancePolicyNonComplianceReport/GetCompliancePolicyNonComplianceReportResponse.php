...
class GetCompliancePolicyNonComplianceReportResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /**
     * Instantiates a new getCompliancePolicyNonComplianceReportResponse and sets the default values.
    */
     ...
     * @return GetCompliancePolicyNonComplianceReportResponse
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): GetCompliancePolicyNonComplianceReportResponse {
