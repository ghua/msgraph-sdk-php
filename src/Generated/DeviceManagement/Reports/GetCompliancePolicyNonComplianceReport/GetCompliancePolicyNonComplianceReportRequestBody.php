...
class GetCompliancePolicyNonComplianceReportRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return GetCompliancePolicyNonComplianceReportRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): GetCompliancePolicyNonComplianceReportRequestBody {
