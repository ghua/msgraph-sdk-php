...
class GetDeviceNonComplianceReportRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    /**
     * Instantiates a new getDeviceNonComplianceReportRequestBody and sets the default values.
    */
     ...
     * @return GetDeviceNonComplianceReportRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): GetDeviceNonComplianceReportRequestBody {
