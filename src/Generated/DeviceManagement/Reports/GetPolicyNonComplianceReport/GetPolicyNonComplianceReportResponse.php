...
class GetPolicyNonComplianceReportResponse implements AdditionalDataHolder, Parsable 
{
    ...
    /**
     * Instantiates a new getPolicyNonComplianceReportResponse and sets the default values.
    */
     ...
     * @return GetPolicyNonComplianceReportResponse
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): GetPolicyNonComplianceReportResponse {
