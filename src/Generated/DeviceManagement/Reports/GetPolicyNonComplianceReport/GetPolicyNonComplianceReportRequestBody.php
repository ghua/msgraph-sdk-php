...
class GetPolicyNonComplianceReportRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return GetPolicyNonComplianceReportRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): GetPolicyNonComplianceReportRequestBody {
