...
class ScheduleActionsForRulesRequestBuilder 
{
    ...
    */
     ...
     * @param ScheduleActionsForRulesRequestBody $body 
     * @param array<string, mixed>|null $headers Request headers
     * @param array<string, RequestOption>|null $options Request options
     * @return RequestInformation
    */
    public function createPostRequestInformation(ScheduleActionsForRulesRequestBody $body, ?array $headers = null, ?array $options = null): RequestInformation {
     ...
     * @return Promise
    */
    public function post(ScheduleActionsForRulesRequestBody $body, ?array $headers = null, ?array $options = null, ?ResponseHandler $responseHandler = null): Promise {
