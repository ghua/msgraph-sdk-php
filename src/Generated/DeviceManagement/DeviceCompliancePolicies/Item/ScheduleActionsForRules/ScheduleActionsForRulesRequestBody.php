...
class ScheduleActionsForRulesRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return ScheduleActionsForRulesRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): ScheduleActionsForRulesRequestBody {
    ...
    */
    public function serialize(SerializationWriter $writer): void {
        $writer->writeCollectionOfObjectValues('deviceComplianceScheduledActionForRules', $this->deviceComplianceScheduledActionForRules);
