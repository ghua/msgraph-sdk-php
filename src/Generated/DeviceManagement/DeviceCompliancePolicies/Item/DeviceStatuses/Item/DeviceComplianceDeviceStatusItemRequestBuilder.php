...
class DeviceComplianceDeviceStatusItemRequestBuilder 
{
    ...
    */
     ...
     * @return RequestInformation
    */
    public function createPatchRequestInformation(DeviceComplianceDeviceStatus $body, ?array $headers = null, ?array $options = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = $this->urlTemplate;
        $requestInfo->pathParameters = $this->pathParameters;
    ...
    */
     ...
     * @return Promise
    */
    public function patch(DeviceComplianceDeviceStatus $body, ?array $headers = null, ?array $options = null, ?ResponseHandler $responseHandler = null): Promise {
