...
class DeviceCompliancePolicyDeviceStateSummaryRequestBuilder 
{
    ...
    */
     ...
     * @param DeviceCompliancePolicyDeviceStateSummary $body 
     * @param array<string, mixed>|null $headers Request headers
     * @param array<string, RequestOption>|null $options Request options
     * @return RequestInformation
    */
    public function createPatchRequestInformation(DeviceCompliancePolicyDeviceStateSummary $body, ?array $headers = null, ?array $options = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = $this->urlTemplate;
        $requestInfo->pathParameters = $this->pathParameters;
    ...
    */
    public function get(?array $queryParameters = null, ?array $headers = null, ?array $options = null, ?ResponseHandler $responseHandler = null): Promise {
        ...
        try {
            return $this->requestAdapter->sendAsync($requestInfo, DeviceCompliancePolicyDeviceStateSummary::class, $responseHandler);
        } catch(Exception $ex) {
            return new RejectedPromise($ex);
        }
    }
     ...
     * @return Promise
    */
    public function patch(DeviceCompliancePolicyDeviceStateSummary $body, ?array $headers = null, ?array $options = null, ?ResponseHandler $responseHandler = null): Promise {
