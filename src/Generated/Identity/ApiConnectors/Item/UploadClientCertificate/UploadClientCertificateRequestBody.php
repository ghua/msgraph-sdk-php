...
class UploadClientCertificateRequestBody implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return UploadClientCertificateRequestBody
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): UploadClientCertificateRequestBody {
