...
class GetMailboxUsageStorageWithPeriodResponse implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return GetMailboxUsageStorageWithPeriodResponse
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): GetMailboxUsageStorageWithPeriodResponse {
