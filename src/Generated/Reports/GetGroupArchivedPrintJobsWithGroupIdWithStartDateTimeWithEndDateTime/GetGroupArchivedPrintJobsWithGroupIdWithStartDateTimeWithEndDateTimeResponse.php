...
class GetGroupArchivedPrintJobsWithGroupIdWithStartDateTimeWithEndDateTimeResponse implements AdditionalDataHolder, Parsable 
{
    ...
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): GetGroupArchivedPrintJobsWithGroupIdWithStartDateTimeWithEndDateTimeResponse {
