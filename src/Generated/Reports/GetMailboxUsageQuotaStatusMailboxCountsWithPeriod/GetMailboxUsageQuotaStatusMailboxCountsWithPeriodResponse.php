...
class GetMailboxUsageQuotaStatusMailboxCountsWithPeriodResponse implements AdditionalDataHolder, Parsable 
{
    ...
    */
     ...
     * @return GetMailboxUsageQuotaStatusMailboxCountsWithPeriodResponse
    */
    public function createFromDiscriminatorValue(ParseNode $parseNode): GetMailboxUsageQuotaStatusMailboxCountsWithPeriodResponse {
